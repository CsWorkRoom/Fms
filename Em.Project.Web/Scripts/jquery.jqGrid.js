...
!function (a) {
    ...
    "use strict"; $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        version: "5.2.1", htmlDecode: function (a) { return a && ("&nbsp;" === a || "&#160;" === a || 1 === a.length && 160 === a.charCodeAt(0)) ? "" : a ? String(a).replace(/&gt;/g, ">").replace(/&lt;/g, "<").replace(/&quot;/g, '"').replace(/&amp;/g, "&") : a }, htmlEncode: function (a) { return a ? String(a).replace(/&/g, "&amp;").replace(/\"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;") : a }, template: function (a) {
            var
        ...
        }, isMobile: function () { try { return !!/Android|webOS|iPhone|iPad|iPod|pocket|psp|kindle|avantgo|blazer|midori|Tablet|Palm|maemo|plucker|phone|BlackBerry|symbian|IEMobile|mobile|ZuneWP7|Windows Phone|Opera Mini/i.test(navigator.userAgent) } catch (a) { return !1 } }, cell_width: !0, ajaxOptions: {}, from: function (source) {
            var
            $t = this, QueryObject = function (d, q) {
                ...
                }, this.contains = function (a, b) { return _useProperties ? self._append(self._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + self._toStr(b) + '",0) > -1') : self._append(self._getStr("this") + '.indexOf("' + self._toStr(a) + '",0) > -1'), self._setCommand(self.contains, a), self._resetNegate(), self }, this.groupBy = function (a, b, c, d) { return self._hasData() ? self._getGroup(_data, a, b, c, d) : null }, this.orderBy = function (a, b, c, d, e) { return b = null == b ? "a" : $.trim(b.toString().toLowerCase()), null == c && (c = "text"), null == d && (d = "Y-m-d"), null == e && (e = !1), "desc" !== b && "descending" !== b || (b = "d"), "asc" !== b && "ascending" !== b || (b = "a"), _sorting.push({ by: a, dir: b, type: c, datefmt: d, sfunc: e }), self }, self
            }; return new
...
b(a, b, c, d) {
                if (e.p.multiselect && e.p.multiboxonly || e.p.multimail) if (b) $(e).jqGrid("setSelection", a, d, c); else
                    if (e.p.multiboxonly && e.p.multimail) $(e).triggerHandler("jqGridSelectRow", [a, !1, c]), e.p.onSelectRow && e.p.onSelectRow.call(e, a, !1, c); else {
                        ...
                        f = e.p.frozenColumns ? e.p.id + "_frozen" : ""; $(e.p.selarrrow).each(function (a, b) {
                            var
                            c = $(e).jqGrid("getGridRowById", b); c && $(c).removeClass(o), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + $.jgrid.jqID(b))[e.p.useProp ? "prop" : "attr"]("checked", !1), f && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f)).removeClass(o), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f))[e.p.useProp ? "prop" : "attr"]("checked", !1))
                ...
                e = this, f = {
                    headers: [], cols: [], footers: [], dragStart: function (a, b, c) {
                        ...
                        b = a.p, c = b.selrow, d = b.selarrrow ? $.makeArray(b.selarrrow) : null, e = a.grid.bDiv.scrollLeft, f = function () {
                            var
                            g; if (b.selrow = null, b.selarrrow = [], b.multiselect && d && d.length > 0) for (g = 0; g < d.length; g++) d[g] !== c && $(a).jqGrid("setSelection", d[g], !1, null); c && $(a).jqGrid("setSelection", c, !1, null), a.grid.bDiv.scrollLeft = e, $(a).off(".selectionPreserver", f)
                ...
                y, z = ["shiftKey", "altKey", "ctrlKey"], A = function (a, b) { return a = parseInt(a, 10), isNaN(a) ? b || 0 : a }, B = function (a, b, c, d, g, h) {
                    var
                ...
                }, C = function (a) { return null == a || "" === a ? "&#160;" : e.p.autoencode ? $.jgrid.htmlEncode(a) : String(a) }, D = function (a, b, c, d, f) {
                    var
                    g, h = e.p.colModel[c]; if (void
                    0 !== h.formatter) {
                        a = "" !== String(e.p.idPrefix) ? $.jgrid.stripPref(e.p.idPrefix, a) : a; var
                        i = { rowId: a, colModel: h, gid: e.p.id, pos: c, styleUI: e.p.styleUI }; g = $.isFunction(h.formatter) ? h.formatter.call(e, b, i, d, f) : $.fmatter ? $.fn.fmatter.call(e, h.formatter, b, i, d, f) : C(b)
                    } else
                        g = C(b); return g
                }, E = function (a, b, c, d, e, f) {
                    var
                    g; return g = D(a, b, c, e, "add"), '<td role="gridcell" ' + B(c, d, g, e, a, f) + ">" + g + "</td>"
                }, F = function (a, b, c, d, f) {
                    var
                    g = '<input role="checkbox" type="checkbox" id="jqg_' + e.p.id + "_" + a + '" ' + f + ' name="jqg_' + e.p.id + "_" + a + '"' + (d ? 'checked="checked"' : "") + "/>"; return '<td role="gridcell" ' + B(b, c, "", null, a, !0) + ">" + g + "</td>"
                }, G = function (a, b, c, d, e) {
                    var
                    f = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b; return '<td role="gridcell" ' + e + " " + B(a, b, f, null, b, !0) + ">" + f + "</td>"
                }, H = function (a) {
                    var
                    ...
                    var
                    a, b, c, d, f, g, h, i, j, k, l, m = e.p, n = m.data, o = n.length, p = m.localReader, q = m.colModel, r = p.cell, s = (!0 === m.multiselect ? 1 : 0) + (!0 === m.subGrid ? 1 : 0) + (!0 === m.rownumbers ? 1 : 0), t = m.scroll ? $.jgrid.randId() : 1; if ("local" === m.datatype && !0 === p.repeatitems) for (j = I(s), k = H("local"), d = !1 === m.keyName ? $.isFunction(p.id) ? p.id.call(e, n) : p.id : m.keyName, a = 0; a < o; a++) {
                    ...
                    var
                    f = new
                    Date, g = "local" !== e.p.datatype && e.p.loadonce || "xmlstring" === e.p.datatype, h = "_id_", i = e.p.xmlReader, j = "local" === e.p.datatype ? "local" : "xml"; if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
                        -1 !== e.p.treeANode || e.p.scroll ? b = b > 1 ? b : 1 : (J.call(e, !1, !0), b = 1); var
                        ...
                        N, O = L.length, P = 0, Q = [], R = parseInt(e.p.rowNum, 10), S = e.p.scroll ? $.jgrid.randId() : 1, T = $(e).find("tbody:first"), U = !1; if (e.p.grouping && (U = !0 === e.p.groupingView.groupCollapse, N = $.jgrid.getMethod("groupingPrepare")), O > 0 && e.p.page <= 0 && (e.p.page = 1), L && O) {
                            d && (R *= d + 1); for (var
                            V = $.isFunction(e.p.afterInsertRow), W = z ? l(m, "rownumBox", !1, "jqgrid-rownum") : "", X = x ? l(m, "multiBox", !1, "cbox") : ""; P < O;) {
                                t = L[P], u = r(t, S + P), u = e.p.idPrefix + u; var
                                Y = D.length; if (D.push(""), z && D.push(G(0, P, e.p.page, e.p.rowNum, W)), x && D.push(F(u, z, P, !1, X)), y && D.push(p.call(v, x + z, P + b)), i.repeatitems) {
                                    s || (s = I(x + y + z)); var
                                    Z = $.jgrid.getXmlData(t, i.cell, !0); $.each(s, function (a) {
                                        var
                                        c = Z[this]; if (!c) return !1; o = c.textContent || c.text, C[e.p.colModel[a + x + y + z].name] = o, D.push(E(u, o, a + x + y + z, P + b, t, C))
                                    })
                                } else
                        ...
                        Date - f, D = null, !0 === e.p.subGrid) try { v.jqGrid("addSubGrid", x + z) } catch (a) { } if (w > 0 && 0 === e.p.records && (e.p.records = O), !0 === e.p.treeGrid) try { v.jqGrid("setTreeNode", n + 1, w + n + 1) } catch (a) { } if (e.p.reccount = w, e.p.treeANode = -1, e.p.userDataOnFooter && v.jqGrid("footerData", "set", e.p.userData, !0), g && (e.p.records = O, e.p.lastpage = Math.ceil(O / R)), c || e.updatepager(!1, !0), g) {
                            for (; w < O;) {
                                if (t = L[w], u = r(t, w + S), u = e.p.idPrefix + u, i.repeatitems) {
                                    s || (s = I(x + y + z)); var
                                    _ = $.jgrid.getXmlData(t, i.cell, !0); $.each(s, function (a) {
                                        var
                                        b = _[this]; if (!b) return !1; o = b.textContent || b.text, C[e.p.colModel[a + x + y + z].name] = o
                                    })
                                } else
                                    for (k = 0; k < B.length; k++) o = $.jgrid.getXmlData(t, B[k]), C[e.p.colModel[k + x + y + z].name] = o; C[h] = $.jgrid.stripPref(e.p.idPrefix, u), e.p.grouping && N.call(v, C, w), e.p.data.push(C), e.p._index[C[h]] = e.p.data.length - 1, C = {}, w++
                    ...
                    Date; if (a) {
                        ...
                        V, W = $.isFunction(e.p.afterInsertRow), X = [], Y = !1, Z = $(e).find("tbody:first"), _ = K ? l(m, "rownumBox", !1, "jqgrid-rownum") : "", aa = C ? l(m, "multiBox", !1, "cbox") : ""; for (e.p.grouping && (Y = !0 === e.p.groupingView.groupCollapse, V = $.jgrid.getMethod("groupingPrepare")) ; n < t;) {
                            if (q = u[n], void
                            ...
                            } x = e.p.idPrefix + x, U && (R = e.p.multiselect ? -1 !== $.inArray(x, e.p.selarrrow) : x === e.p.selrow); var
                        ...
                        Date - f, P = null, !0 === e.p.subGrid) try { y.jqGrid("addSubGrid", C + K) } catch (a) { } if (z > 0 && 0 === e.p.records && (e.p.records = t), !0 === e.p.treeGrid) try { y.jqGrid("setTreeNode", w + 1, z + w + 1) } catch (a) { } if (e.p.reccount = z, e.p.treeANode = -1, e.p.userDataOnFooter && y.jqGrid("footerData", "set", e.p.userData, !0), j && (e.p.records = t, e.p.lastpage = Math.ceil(t / S)), c || e.updatepager(!1, !0), j) {
                            for (; z < t && u[z];) {
                                ...
                                } if (q) { for (x = e.p.idPrefix + x, s = N, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = L)), p = 0; p < s.length; p++) O[e.p.colModel[p + C + D + K].name] = $.jgrid.getAccessor(q, s[p]); O[i] = $.jgrid.stripPref(e.p.idPrefix, x), e.p.grouping && V.call(y, O, z), e.p.data.push(O), e.p._index[O[i]] = e.p.data.length - 1, O = {} } z++
...
b(a) {
                    ...
                    c, d, f, g, h = e.p.multiSort ? [] : "", i = [], j = !1, k = {}, l = [], m = []; if ($.isArray(e.p.data)) {
                        ...
                        r = { eq: function (a) { return a.equals }, ne: function (a) { return a.notEquals }, lt: function (a) { return a.less }, le: function (a) { return a.lessOrEquals }, gt: function (a) { return a.greater }, ge: function (a) { return a.greaterOrEquals }, cn: function (a) { return a.contains }, nc: function (a, b) { return "OR" === b ? a.orNot().contains : a.andNot().contains }, bw: function (a) { return a.startsWith }, bn: function (a, b) { return "OR" === b ? a.orNot().startsWith : a.andNot().startsWith }, en: function (a, b) { return "OR" === b ? a.orNot().endsWith : a.andNot().endsWith }, ew: function (a) { return a.endsWith }, ni: function (a, b) { return "OR" === b ? a.orNot().equals : a.andNot().equals }, in: function (a) { return a.equals }, nu: function (a) { return a.isNull }, nn: function (a, b) { return "OR" === b ? a.orNot().isNull : a.andNot().isNull } }, s = $.jgrid.from.call(e, e.p.data); if (e.p.ignoreCase && (s = s.ignoreCase()), !0 === e.p.search) {
                            ...
                            t && (t = $.jgrid.parse(t)), b(t); else
                                try { g = k[e.p.postData.searchField], "date" === g.stype && g.srcfmt && g.newfmt && g.srcfmt !== g.newfmt && (e.p.postData.searchString = $.jgrid.parseDate.call(e, g.newfmt, e.p.postData.searchString, g.srcfmt)), s = r[e.p.postData.searchOper](s)(e.p.postData.searchField, e.p.postData.searchString, k[e.p.postData.searchField]) } catch (a) { }
                        } else
                            ...
                            w = s.select(), x = parseInt(e.p.rowNum, 10), y = w.length, z = parseInt(e.p.page, 10), A = Math.ceil(y / x), B = {}; if ((e.p.search || e.p.resetsearch) && e.p.grouping && e.p.groupingView._locgr) {
                                ...
                                C, D, E, F = $.jgrid.getMethod("groupingPrepare"); if (e.p.footerrow && e.p.userDataOnFooter) {
                                    ...
                                    if (E) for (D
                                    in
                                    e.p.userData) e.p.userData.hasOwnProperty(D) && (e.p.userData[D] += parseFloat(w[C][D] || 0)); F.call($(e), w[C], C, x)
                                }
                    ...
                    var
                    c, d, f, g, h, i, j, k, o = "", q = e.p.pager ? $.jgrid.jqID(e.p.pager.substr(1)) : "", r = q ? "_" + q : "", s = e.p.toppager ? "_" + e.p.toppager.substr(1) : ""; if (f = parseInt(e.p.page, 10) - 1, f < 0 && (f = 0), f *= parseInt(e.p.rowNum, 10), h = f + e.p.reccount, e.p.scroll) {
                        var
                        ...
                        if (j = $.jgrid.getRegional(e, "formatter.integer"), c = A(e.p.page), d = A(e.p.lastpage), $(".selbox", o)[this.p.useProp ? "prop" : "attr"]("disabled", !1), !0 === e.p.pginput && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")), e.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")), $(".ui-pg-input", o).val(e.p.page), k = e.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(k).html($.fmatter ? $.fmatter.util.NumberFormat(e.p.lastpage, j) : e.p.lastpage)), e.p.viewrecords) if (0 === e.p.reccount) $(".ui-paging-info", o).html($.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords)); else {
                            ...
                            x = $.jgrid.getRegional(e, "defaults.recordtext", e.p.recordtext); $(".ui-paging-info", o).html($.jgrid.template(x, g, h, i))
                ...
                }, R = function () { e.grid.hDiv.loading = !0, e.p.hiddengrid || $(e).jqGrid("progressBar", { method: "show", loadtype: e.p.loadui, htmlcontent: $.jgrid.getRegional(e, "defaults.loadtext", e.p.loadtext) }) }, S = function () { e.grid.hDiv.loading = !1, $(e).jqGrid("progressBar", { method: "hide", loadtype: e.p.loadui }) }, T = function (a, b, c) {
                    var
                ...
                }, U = function (a, b) { $(e).triggerHandler("jqGridLoadComplete", [a]), b && e.p.loadComplete.call(e, a), $(e).triggerHandler("jqGridAfterLoadComplete", [a]), e.p.datatype = "local", e.p.datastr = null, S() }, V = function (a) {
                    if (!e.grid.hDiv.loading) {
                        ...
                        e.p.postData[g.npage], e.p.grouping) {
                            ...
                            k, l = e.p.groupingView, m = ""; for (k = 0; k < l.groupField.length; k++) {
                                var
                                n = l.groupField[k]; $.each(e.p.colModel, function (a, b) { b.name === n && b.index && (n = b.index) }), m += n + " " + l.groupOrder[k] + ", "
                            } f[g.sort] = m + f[g.sort]
                        ...
                        p = $(e).triggerHandler("jqGridBeforeRequest"); if (!1 === p || "stop" === p) return; if ($.isFunction(e.p.beforeRequest) && (!1 === (p = e.p.beforeRequest.call(e)) || "stop" === p)) return; switch (b = e.p.datatype.toLowerCase()) {
                            case "json": case "jsonp": case "xml": case "script": $.ajax($.extend({
                                url: e.p.url, type: e.p.mtype, dataType: b, data: $.isFunction(e.p.serializeGridData) ? e.p.serializeGridData.call(e, e.p.postData) : e.p.postData, success: function (c, f, g) {
                                    ...
                                    S(); "xml" === b ? N(c, o, a > 1, j) : O(c, o, a > 1, j), $(e).triggerHandler("jqGridLoadComplete", [c]), i && i.call(e, c), $(e).triggerHandler("jqGridAfterLoadComplete", [c]), d && e.grid.populateVisible(), (e.p.loadonce || e.p.treeGrid) && (e.p.datatype = "local"), c = null, 1 === a && S()
                                }, error: function (b, c, d) { $(e).triggerHandler("jqGridLoadError", [b, c, d]), $.isFunction(e.p.loadError) && e.p.loadError.call(e, b, c, d), 1 === a && S(), b = null }, beforeSend: function (a, b) {
                                    var
                                    c = !0; if (c = $(e).triggerHandler("jqGridLoadBeforeSend", [a, b]), $.isFunction(e.p.loadBeforeSend) && (c = e.p.loadBeforeSend.call(e, a, b)), void
                                    0 === c && (c = !0), !1 === c) return !1; R()
                                }
                            }, $.jgrid.ajaxOptions, e.p.ajaxGridOptions)); break; case "xmlstring": if (R(), c = "string" != typeof
                            ...
                            S(); O(q, o, a > 1, j), $(e).triggerHandler("jqGridLoadComplete", [q]), i && i.call(e, q), $(e).triggerHandler("jqGridAfterLoadComplete", [q]), d && e.grid.populateVisible(), S(), e.p._ald = !1
                        } e.p._sort = !1
                    }
                }, W = function (a) { $("#cb_" + $.jgrid.jqID(e.p.id), e.grid.hDiv)[e.p.useProp ? "prop" : "attr"]("checked", a), (e.p.frozenColumns ? e.p.id + "_frozen" : "") && $("#cb_" + $.jgrid.jqID(e.p.id), e.grid.fhDiv)[e.p.useProp ? "prop" : "attr"]("checked", a) }, X = function (a, b) {
                    var
                    c, d, f, g, h, j, k, o = "<td class='ui-pg-button " + n + "'><span class='ui-separator'></span></td>", q = "", s = "<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>", t = "", u = function (a, b) {
                        var
                        c; return "stop" !== (c = $(e).triggerHandler("jqGridPaging", [a, b])) && ($.isFunction(e.p.onPaging) && (c = e.p.onPaging.call(e, a, b)), "stop" !== c && (e.p.selrow = null, e.p.multiselect && (e.p.selarrrow = [], W(!1)), e.p.savedRow = [], !0))
                        ...
                        t = '<td dir="' + i + '">', t += "<select " + l(m, "pgSelectBox", !1, "ui-pg-selbox") + ' role="listbox" title="' + ($.jgrid.getRegional(e, "defaults.pgrecs", e.p.pgrecs) || "") + '">'; var
                        v; for (k = 0; k < e.p.rowList.length; k++) v = e.p.rowList[k].toString().split(":"), 1 === v.length && (v[1] = v[0]), t += '<option role="option" value="' + v[0] + '"' + (A(e.p.rowNum, 0) === A(v[0], 0) ? ' selected="selected"' : "") + ">" + v[1] + "</option>"; t += "</select></td>"
                        ...
                        var
                        w = ["first" + b, "prev" + b, "next" + b, "last" + b], x = l(m, "pgButtonBox", !0, "ui-pg-button"), y = [$.jgrid.getRegional(e, "defaults.pgfirst", e.p.pgfirst) || "", $.jgrid.getRegional(e, "defaults.pgprev", e.p.pgprev) || "", $.jgrid.getRegional(e, "defaults.pgnext", e.p.pgnext) || "", $.jgrid.getRegional(e, "defaults.pglast", e.p.pglast) || ""]; "rtl" === i && (w.reverse(), y.reverse()), s += "<td id='" + w[0] + "' class='" + x + "' title='" + y[0] + "'><span " + l(m, "icon_first", !1, r) + "></span></td>", s += "<td id='" + w[1] + "' class='" + x + "'  title='" + y[1] + "'><span " + l(m, "icon_prev", !1, r) + "></span></td>", s += "" !== q ? o + q + o : "", s += "<td id='" + w[2] + "' class='" + x + "' title='" + y[2] + "'><span " + l(m, "icon_next", !1, r) + "></span></td>", s += "<td id='" + w[3] + "' class='" + x + "' title='" + y[3] + "'><span " + l(m, "icon_end", !1, r) + "></span></td>"
                    } else "" !== q && (s += q); "ltr" === i && (s += t), s += "</tr></tbody></table>", !0 === e.p.viewrecords && $("td#" + a + "_" + e.p.recordpos, "#" + c).append("<div dir='" + i + "' style='text-align:" + e.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + e.p.pagerpos, "#" + c).append(s), j = $("#gbox_" + $.jgrid.jqID(e.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(e.p.id)).append("<div id='testpg' " + l(m, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), h = $(s).clone().appendTo("#testpg").width(), $("#testpg").remove(), h > 0 && ("" !== q && (h += 50), $("td#" + a + "_" + e.p.pagerpos, "#" + c).width(h)), e.p._nvtd = [], e.p._nvtd[0] = h ? Math.floor((e.p.width - h) / 2) : Math.floor(e.p.width / 3), e.p._nvtd[1] = 0, s = null, $(".ui-pg-selbox", "#" + c).on("change", function () { return !!u("records", this) && (e.p.page = Math.round(e.p.rowNum * (e.p.page - 1) / this.value - .5) + 1, e.p.rowNum = this.value, e.p.pager && $(".ui-pg-selbox", e.p.pager).val(this.value), e.p.toppager && $(".ui-pg-selbox", e.p.toppager).val(this.value), V(), !1) }), !0 === e.p.pgbuttons && ($(".ui-pg-button", "#" + c).hover(function () { $(this).hasClass(n) ? this.style.cursor = "default" : ($(this).addClass(p), this.style.cursor = "pointer") }, function () { $(this).hasClass(n) || ($(this).removeClass(p), this.style.cursor = "default") }), $("#first" + $.jgrid.jqID(b) + ", #prev" + $.jgrid.jqID(b) + ", #next" + $.jgrid.jqID(b) + ", #last" + $.jgrid.jqID(b)).click(function () {
                        if ($(this).hasClass(n)) return !1; var
                    ...
                    })), !0 === e.p.pginput && $("#" + c).on("keypress", "input.ui-pg-input", function (a) { return 13 === (a.charCode || a.keyCode || 0) ? !!u("user", this) && ($(this).val(A($(this).val(), 1)), e.p.page = $(this).val() > 0 ? $(this).val() : e.p.page, V(), !1) : this })
                }, Y = function (a, b, c) {
                    var
                    ...
                    j = 0, k = u.length; j < k; j++) j > 0 && (e.p.sortname += ", "), e.p.sortname += u[j], j !== k - 1 && (e.p.sortname += " " + v[j]); e.p.sortorder = v[k - 1]
                    ...
                    if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
                        ...
                        } if ("stop" === $(e).triggerHandler("jqGridSortCol", [e.p.sortname, b, e.p.sortorder])) return void (e.p.lastsort = b); if ($.isFunction(e.p.onSortCol) && "stop" === e.p.onSortCol.call(e, e.p.sortname, b, e.p.sortorder)) return void (e.p.lastsort = b); if ("local" === e.p.datatype ? e.p.deselectAfterSort && $(e).jqGrid("resetSelection") : (e.p.selrow = null, e.p.multiselect && W(!1), e.p.selarrrow = [], e.p.savedRow = []), e.p.scroll) {
                            var
                            k = e.grid.bDiv.scrollLeft; J.call(e, !0, !1), e.grid.hDiv.scrollLeft = k
                        } e.p.subGrid && "local" === e.p.datatype && $("td.sgexpanded", "#" + $.jgrid.jqID(e.p.id)).each(function () { $(this).trigger("click") }), e.p._sort = !0, V(), e.p.lastsort = b, e.p.sortname !== a && b && (e.p.lastsort = b)
                    }
                }, _ = function () {
                    var
                    a, b, c, d, g = 0, h = $.jgrid.cell_width ? 0 : A(e.p.cellLayout, 0), i = 0, j = A(e.p.scrollOffset, 0), k = !1, l = 0; $.each(e.p.colModel, function () {
                        if (void
                    ...
                    }), isNaN(e.p.width) && (e.p.width = g + (!1 !== e.p.shrinkToFit || isNaN(e.p.height) ? 0 : j)), f.width = parseInt(e.p.width, 10), e.p.tblwidth = g, !1 === e.p.shrinkToFit && !0 === e.p.forceFit && (e.p.forceFit = !1), !0 === e.p.shrinkToFit && i > 0 && (c = f.width - h * i - l, isNaN(e.p.height) || (c -= j, k = !0), g = 0, $.each(e.p.colModel, function (d) { !1 !== this.hidden || this.fixed || (b = Math.round(c * this.width / (e.p.tblwidth - h * i - l)), this.width = b, g += b, a = d) }), d = 0, k ? f.width - l - (g + h * i) !== j && (d = f.width - l - (g + h * i) - j) : k || 1 === Math.abs(f.width - l - (g + h * i)) || (d = f.width - l - (g + h * i)), e.p.colModel[a].width += d, e.p.tblwidth = g + d + h * i + l, e.p.tblwidth > e.p.width && (e.p.colModel[a].width -= e.p.tblwidth - parseInt(e.p.width, 10), e.p.tblwidth = e.p.width))
                }, aa = function (a) {
                    var
                    ...
                    var
                    d, f, g = e.p.colModel, h = g.length, i = [], j = $.jgrid.getRegional(e, "colmenu"), k = '<ul id="col_menu" class="ui-search-menu  ui-col-menu modal-content" role="menu" tabindex="0" style="left:' + b + "px;top:" + a + 'px;">'; for (d = 0; d < h; d++) {
                        var
                        ...
                        var
                        b; $(a.target).hasClass("notclick") || ($(a.target).is(":input") ? b = $(a.target).is(":checked") : (b = !$("input", this).is(":checked"), $("input", this).prop("checked", b)), b ? ($(e).jqGrid("showCol", $("input", this).attr("name")), $(this).parent().attr("draggable", "true")) : ($(e).jqGrid("hideCol", $("input", this).attr("name")), $(this).parent().attr("draggable", "false")))
                    }).hover(function () { $(this).addClass(p) }, function () { $(this).removeClass(p) })
                }, ea = function (a, b, c, d) {
                    var
                    f, g, h, i, j, k = e.p.colModel[a], l = "", m = "", n = "", o = "", q = "", r = "", t = ["eq", "ne", "lt", "le", "gt", "ge", "nu", "nn", "in", "ni"], u = ["eq", "ne", "bw", "bn", "ew", "en", "cn", "nc", "nu", "nn", "in", "ni"], v = $.jgrid.getRegional(e, "search"), w = $.jgrid.styleUI[e.p.styleUI || "jQueryUI"].common; if (k) {
                    ...
                    b = parseInt(b, 10), c = parseInt(c, 10) + 25; var
                    d, f, g = $(".ui-jqgrid-view").css("font-size") || "11px", h = '<ul id="column_menu" class="ui-search-menu modal-content column-menu" role="menu" tabindex="0" style="font-size:' + g + ";left:" + b + "px;top:" + c + 'px;">', i = e.p.colModel[a], j = $.extend({ sorting: !0, columns: !0, filtering: !0, seraching: !0, grouping: !0, freeze: !0 }, i.coloptions), k = $.jgrid.getRegional(e, "colmenu"), l = e.p.colNames[a]; if (j.sorting && (h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_sort_asc + '"></span></td><td class="menu_text">' + k.sortasc + "</td></tr></table></a></li>", h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_sort_desc + '"></span></td><td class="menu_text">' + k.sortdesc + "</td></tr></table></a></li>"), j.columns && (h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="columns"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_columns + '"></span></td><td class="menu_text">' + k.columns + "</td></tr></table></a></li>"), j.filtering && (h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="filtering"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_filter + '"></span></td><td class="menu_text">' + k.filter + " " + l + "</td></tr></table></a></li>"), j.grouping && (d = $.inArray(i.name, e.p.groupingView.groupField), h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="grouping"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_group + '"></span></td><td class="menu_text">' + (-1 !== d ? k.ungrouping : k.grouping + " " + l) + "</td></tr></table></a></li>"), j.freeze && (f = !i.frozen || !e.p.frozenColumns, h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="freeze"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_freeze + '"></span></td><td class="menu_text">' + (f ? k.freeze + " " + l : k.unfreeze) + "</td></tr></table></a></li>"), h += "</ul>", $("body").append(h), $("#column_menu").addClass("ui-menu " + s.menu_widget), "ltr" === e.p.direction) {
                        var
                        m = $("#column_menu").width() + 26; $("#column_menu").css("left", b - m + "px")
                    } $("#column_menu > li > a").hover(function () {
                        $("#col_menu").remove(), $("#search_menu").remove(); var
                        b, c; "columns" === $(this).attr("value") && (b = $(this).parent().width() + 18, c = $(this).parent().position().top - 5, da(c, b, $(this).parent())), "filtering" === $(this).attr("value") && (b = $(this).parent().width() + 18, c = $(this).parent().position().top - 5, ea(a, c, b, $(this).parent())), $(this).addClass(p)
                    }, function () { $(this).removeClass(p) }).click(function () {
                        var
                        b = $(this).attr("value"), c = e.grid.headers[a].el; "sortasc" === b ? Z("jqgh_" + e.p.id + "_" + i.name, a, !0, "asc", c) : "sortdesc" === b ? Z("jqgh_" + e.p.id + "_" + i.name, a, !0, "desc", c) : "grouping" === b ? ga(a, d) : "freeze" === b && ha(a, f), -1 === b.indexOf("sort") && "grouping" !== b && "freeze" !== b || $(this).remove()
                    })
                }; for (e.p.colMenu && $("body").on("click", function (a) { $(a.target).closest(".column-menu").length || $("#column_menu").remove() }), this.p.id = this.id, -1 === $.inArray(e.p.multikey, z) && (e.p.multikey = !1), e.p.keyName = !1, j = 0; j < e.p.colModel.length; j++) y = "string" == typeof
                ...
                ja, ka, la, ma, na, oa, pa, qa, ra, sa = "<thead><tr class='ui-jqgrid-labels' role='row'>", ta = "", ua = "", va = ""; if (!0 === e.p.shrinkToFit && !0 === e.p.forceFit) for (j = e.p.colModel.length - 1; j >= 0; j--) if (!e.p.colModel[j].hidden) { e.p.colModel[j].resizable = !1; break } if ("horizontal" === e.p.viewsortcols[1] ? (ua = " ui-i-asc", va = " ui-i-desc") : "single" === e.p.viewsortcols[1] && (ua = " ui-single-sort-asc", va = " ui-single-sort-desc", ta = " style='display:none'", e.p.viewsortcols[0] = !1), ja = t ? "class='ui-th-div-ie'" : "", qa = "<span class='s-ico' style='display:none'>", qa += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + ua + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_asc", !0) + "'" + ta + "></span>", qa += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + va + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_desc", !0) + "'" + ta + "></span></span>", e.p.multiSort && e.p.sortname) for (u = e.p.sortname.split(","), j = 0; j < u.length; j++) w = $.trim(u[j]).split(" "), u[j] = $.trim(w[0]), v[j] = w[1] ? $.trim(w[1]) : e.p.sortorder || "asc"; for (j = 0; j < this.p.colNames.length; j++) {
                    var
                ...
                Ba = $("tr:first", sa), Ca = "<tr class='jqgfirstrow' role='row'>"; if (e.p.disableClick = !1, $("th", Ba).each(function (a) {
                ...
                var
                b = ca(this); return !0 === e.p.forceFit && (e.p.nv = aa(b)), f.dragStart(b, a, ba(b)), !1
                }
                }).click(function (a) {
                ...
                f = $(a.target).closest(d); if (1 === f.length) {
                var
                g; if (e.p.frozenColumns) {
                var
                h = $(this)[0].id.substring(e.p.id.length + 1); $(e.p.colModel).each(function (a) { if (this.name === h) return g = a, !1 })
                } else
                g = ca(this); if ($(a.target).hasClass("colmenuspan")) {
                null != $("#column_menu")[0] && $("#column_menu").remove(); var
                ...
                }), ra = null, e.p.sortable && $.fn.sortable) try { $(e).jqGrid("sortableColumns", Ba) } catch (a) { } e.p.footerrow && (Aa += "</tr></tbody></table>"), Ca += "</tr>", pa = document.createElement("tbody"), this.appendChild(pa), $(this).addClass(l(m, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Ca), e.p.altRows && $(this).addClass(l(m, "stripedTable", !0, "")), Ca = null; var
                ...
                Ha, Ia, Ja; $(e).before(f.hDiv).on({
                    click: function (a) {
                        if (na = a.target, oa = $(na, e.rows).closest("tr.jqgrow"), 0 === $(oa).length || oa[0].className.indexOf(n) > -1 || ($(na, e).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== e.id) return this; var
                        c = $(na).filter(":enabled").hasClass("cbox"), d = $(e).triggerHandler("jqGridBeforeSelectRow", [oa[0].id, a]); if (d = !1 !== d && "stop" !== d, $.isFunction(e.p.beforeSelectRow)) {
                            var
                            f = e.p.beforeSelectRow.call(e, oa[0].id, a); !1 !== f && "stop" !== f || (d = !1)
                            ...
                            if (na.length > 0 && (Ja = $(na).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ha, Ia, Ja, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ha, Ia, Ja, a)), d) if (e.p.multimail && e.p.multiselect) {
                                if (a.shiftKey) {
                                    if (c) {
                                        ...
                                        l = !1, m = !1, o = !0; return $.inArray(Ha, e.p.selarrrow) > -1 && (o = !1), $.each($(this).getDataIDs(), function (a, b) { return (m = b === j || m) && $(e).jqGrid("resetSelection", b), b !== k }), o && $.each($(this).getDataIDs(), function (a, b) { return (l = b === j || l) && $(e).jqGrid("setSelection", b, !1), b !== k }), void (e.p.selrow = h > i ? k : j)
                            ...
                            if (e.p.multiselect && c && d) $(e).jqGrid("setSelection", Ha, !0, a); else
                                if (na.length > 0) try { $(e).jqGrid("editCell", oa[0].rowIndex, Ia, !0) } catch (a) { }
                        ...
                        if (na = a.target, oa = $(na, e.rows).closest("tr.jqgrow"), 0 !== $(oa).length) {
                            Ha = oa[0].rowIndex, Ia = $.jgrid.getCellIndex(na); var
                        ...
                        if (na = a.target, oa = $(na, e.rows).closest("tr.jqgrow"), 0 !== $(oa).length) {
                            e.p.multiselect || $(e).jqGrid("setSelection", oa[0].id, !0, a), Ha = oa[0].rowIndex, Ia = $.jgrid.getCellIndex(na); var
                ...
                Ma = !0 === e.p.hidegrid ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + q + "' title='" + ($.jgrid.getRegional(e, "defaults.showhide", e.p.showhide) || "") + "' />").hover(function () { Ma.addClass(p) }, function () { Ma.removeClass(p) }).append("<span class='ui-jqgrid-headlink " + Ka + "'></span>").css("rtl" === i ? "left" : "right", "0px") : ""; if ($(f.cDiv).append(Ma).append("<span class='ui-jqgrid-title'>" + e.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === i ? "-rtl" : "") + " " + l(m, "gridtitleBox", !0)), $(f.cDiv).insertBefore(f.hDiv), e.p.toolbar[0]) {
                    ...
                    var
                    Oa = e.p.datatype; !0 === e.p.hidegrid && ($(".ui-jqgrid-titlebar-close", f.cDiv).click(function (a) {
                        var
                        b, c = $.isFunction(e.p.onHeaderClick), d = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv", g = this; return !0 === e.p.toolbar[0] && ("both" === e.p.toolbar[1] && (d += ", #" + $(f.ubDiv).attr("id")), d += ", #" + $(f.uDiv).attr("id")), b = $(d, "#gview_" + $.jgrid.jqID(e.p.id)).length, "visible" === e.p.gridstate ? $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideUp("fast", function () { 0 === --b && ($("span", g).removeClass(Ka).addClass(La), e.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(e.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(e.p.id)).hide(), $(e).triggerHandler("jqGridHeaderClick", [e.p.gridstate, a]), c && (Ea || e.p.onHeaderClick.call(e, e.p.gridstate, a))) }) : "hidden" === e.p.gridstate && $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideDown("fast", function () { 0 === --b && ($("span", g).removeClass(La).addClass(Ka), Ea && (e.p.datatype = Oa, V(), Ea = !1), e.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(e.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(e.p.id)).show(), $(e).triggerHandler("jqGridHeaderClick", [e.p.gridstate, a]), c && (Ea || e.p.onHeaderClick.call(e, e.p.gridstate, a))) }), !1
                    ...
                    var
                    a = f.bDiv.offsetWidth - f.bDiv.clientWidth; e.p.scrollOffset = a, $("div:first", f.hDiv).css({ paddingLeft: a + "px" }), f.hDiv.scrollLeft = f.bDiv.scrollLeft
                    }), e.formatCol = B, e.sortData = Z, e.updatepager = Q, e.refreshIndex = L, e.setHeadCheckBox = W, e.constructTr = M, e.formatter = function (a, b, c, d, e) { return D(a, b, c, d, e) }, $.extend(f, { populate: V, emptyRows: J, beginReq: R, endReq: S }), this.grid = f, e.addXmlData = function (a) { N(a) }, e.addJSONData = function (a) { O(a) }, e.addLocalData = function (a) { return P(a) }, this.grid.cols = this.rows[0].cells, $.isFunction(e.p.onInitGrid) && e.p.onInitGrid.call(e), V(), e.p.hiddengrid = !1, e.p.responsive) {
                        var
                        Pa = "onorientationchange" in
                        window, Qa = Pa ? "orientationchange" : "resize"; $(window).on(Qa, function () { $(e).jqGrid("resizeGrid") })
                    }
            }
        })
    }, $.jgrid.extend({
        getGridParam: function (a, b) {
            ...
            b; return this.each(function () {
                ...
                } catch (c) { b = $(this.grid.bDiv).find("#" + $.jgrid.jqID(a)) }
            }), b
        }, getDataIDs: function () {
            var
...
d(a) {
                    var
                    b = $(l.grid.bDiv)[0].clientHeight, c = $(l.grid.bDiv)[0].scrollTop, d = $(l.rows[a]).position().top, e = l.rows[a].clientHeight; d + e >= b + c ? $(l.grid.bDiv)[0].scrollTop = d - (b + c) + e + c : d < b + c && d < c && ($(l.grid.bDiv)[0].scrollTop = d)
                } var
...
e(b, c) {
                ...
                if (this.grid) {
                    ...
                    b && (b = g.p.shrinkToFit), !isNaN(a)) {
                        if (a = parseInt(a, 10), g.grid.width = g.p.width = a, $("#gbox_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $("#gview_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $(g.grid.bDiv).css("width", a - n + "px"), $(g.grid.hDiv).css("width", a - n + "px"), g.p.pager && $(g.p.pager).css("width", a + "px"), g.p.toppager && $(g.p.toppager).css("width", a - n + "px"), !0 === g.p.toolbar[0] && ($(g.grid.uDiv).css("width", a - n + "px"), "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a - n + "px")), g.p.footerrow && $(g.grid.sDiv).css("width", a - n + "px"), !1 === b && !0 === g.p.forceFit && (g.p.forceFit = !1), !0 === b) {
                            if ($.each(g.p.colModel, function () { !1 === this.hidden && (c = this.widthOrg, h += c + i, this.fixed ? m += c + i : j++) }), 0 === j) return; g.p.tblwidth = h, e = a - i * j - m, isNaN(g.p.height) || ($(g.grid.bDiv)[0].clientHeight < $(g.grid.bDiv)[0].scrollHeight || 1 === g.rows.length) && (k = !0, e -= l), h = 0; var
                            o = g.grid.cols.length > 0; if ($.each(g.p.colModel, function (a) { if (!1 === this.hidden && !this.fixed) { if (c = this.widthOrg, (c = Math.round(e * c / (g.p.tblwidth - i * j - m))) < 0) return; this.width = c, h += c, g.grid.headers[a].width = c, g.grid.headers[a].el.style.width = c + "px", g.p.footerrow && (g.grid.footers[a].style.width = c + "px"), o && (g.grid.cols[a].style.width = c + "px"), d = a } }), !d) return; if (f = 0, k ? a - m - (h + i * j) !== l && (f = a - m - (h + i * j) - l) : 1 !== Math.abs(a - m - (h + i * j)) && (f = a - m - (h + i * j)), g.p.colModel[d].width += f, g.p.tblwidth = h + f + i * j + m, g.p.tblwidth > a) {
                                var
                                p = g.p.tblwidth - parseInt(a, 10); g.p.tblwidth = a, c = g.p.colModel[d].width = g.p.colModel[d].width - p
                            } else
                                c = g.p.colModel[d].width; g.grid.headers[d].width = c, g.grid.headers[d].el.style.width = c + "px", o && (g.grid.cols[d].style.width = c + "px"), g.p.footerrow && (g.grid.footers[d].style.width = c + "px")
                    ...
                    $.each(g.p.colModel, function (ii) {
                        if(this.hidden == false && !this.fixed) {
                            ...
                            this.width = c;
                            h += c;
                            g.grid.headers[ii].width = c;
                            g.grid.headers[ii].el.style.width = c + "px";
                            $(g.grid.hDiv).find('.jqg-first-row-header th:eq(' + ii + ')').css({
                                width: c + "px"
                            }); //mod by xss 窗口缩放时发现对不齐
                            if(g.p.footerrow) {
                                g.grid.footers[ii].style.width = c + "px";
                            }
                            if(o) {
                                g.grid.cols[ii].style.width = c + "px";
                            }
                            d = ii;
                        }
                    });
                    ...
                    } else if(Math.abs(a - m - (h + i * j)) != 1) {
                        cr = a - m - (h + i * j);
                    }
                    g.p.colModel[d].width += cr;
                    g.p.tblwidth = h + cr + i * j + m;
                    if(g.p.tblwidth > a) {
                        var delta = g.p.tblwidth - parseInt(a, 10);
                        g.p.tblwidth = a;
                        c = g.p.colModel[d].width = g.p.colModel[d].width - delta;
                    } else {
            ...
            return this.each(function () {
                ...
                g, h, i = this, j = -1; if (i.grid && (isNaN(b) ? $(i.p.colModel).each(function (a) { if (this.name === b) return j = a, !1 }) : j = parseInt(b, 10), j >= 0)) {
                    ...
                    k = $(i).jqGrid("getGridRowById", a); if (k) {
                        var
                        l = $("td:eq(" + j + ")", k), m = 0, n = []; if ("" !== c || !0 === f) {
                            if (void
                            0 !== k.cells) for (; m < k.cells.length;) n.push(k.cells[m].innerHTML), m++; if (g = i.formatter(a, c, j, n, "edit"), h = i.p.colModel[j].title ? { title: $.jgrid.stripHtml(g) } : {}, i.p.treeGrid && $(".tree-wrap", $(l)).length > 0 ? $("span", $(l)).html(g).attr(h) : $(l).html(g).attr(h), "local" === i.p.datatype) {
                                var
            ...
            0 === c && (c = !1), this.each(function () {
                var
                j = this, k = -1; if (j.grid && (isNaN(a) ? $(j.p.colModel).each(function (b) { if (this.name === a) return k = b, !1 }) : k = parseInt(a, 10), k >= 0)) {
                    var
                    l = j.rows.length, m = 0, n = 0; if (l && l > 0) {
                        for (; m < l;) {
                            if ($(j.rows[m]).hasClass("jqgrow")) {
                                try { d = $.unformat.call(j, $(j.rows[m].cells[k]), { rowId: j.rows[m].id, colModel: j.p.colModel[k] }, k) } catch (a) { d = $.jgrid.htmlDecode(j.rows[m].cells[k].innerHTML) } c ? (g = parseFloat(d), isNaN(g) || (i += g, void
                                0 === f && (f = e = g), e = Math.min(e, g), f = Math.max(f, g), n++)) : b ? h.push({ id: j.rows[m].id, value: d }) : h.push(d)
                            } m++
                        } if (c) switch (c.toLowerCase()) { case "sum": h = i; break; case "avg": h = i / n; break; case "count": h = l - 1; break; case "min": h = e; break; case "max": h = f }
                    }
                }
            }), h
            ...
            return this.each(function () {
                ...
                b = this; if (b.grid) {
                    ...
                    a && (a = !1), b.p.deepempty) $("#" + $.jgrid.jqID(b.p.id) + " tbody:first tr:gt(0)").remove(); else {
                        var
                        c = $("#" + $.jgrid.jqID(b.p.id) + " tbody:first tr:first")[0]; $("#" + $.jgrid.jqID(b.p.id) + " tbody:first").empty().append(c)
            ...
            b = $.extend({ onEnter: null, onSpace: null, onLeftKey: null, onRightKey: null, scrollingRows: !0 }, a || {}); return this.each(function () {
                var
                a = this; $("body").is("[role]") || $("body").attr("role", "application"), a.p.scrollrows = b.scrollingRows, $(a).keydown(function (c) {
                    var
                    d, e, f, g = $(a).find("tr[tabindex=0]")[0], h = a.p.treeReader.expanded_field; if (g) if (f = a.p._index[$.jgrid.stripPref(a.p.idPrefix, g.id)], 37 === c.keyCode || 38 === c.keyCode || 39 === c.keyCode || 40 === c.keyCode) {
                        if (38 === c.keyCode) {
                            if (e = g.previousSibling, d = "", e) if ($(e).is(":hidden")) { for (; e;) if (e = e.previousSibling, !$(e).is(":hidden") && $(e).hasClass("jqgrow")) { d = e.id; break } } else
                                d = e.id; $(a).jqGrid("setSelection", d, !0, c), c.preventDefault()
                        } if (40 === c.keyCode) {
                            if (e = g.nextSibling, d = "", e) if ($(e).is(":hidden")) { for (; e;) if (e = e.nextSibling, !$(e).is(":hidden") && $(e).hasClass("jqgrow")) { d = e.id; break } } else
                                d = e.id; $(a).jqGrid("setSelection", d, !0, c), c.preventDefault()
                ...
                if (this.grid) {
                    ...
                    a = this, b = a.p.colModel, c = 0, d = b.length, e = -1, f = !1, g = $(a).jqGrid("getStyleUI", a.p.styleUI + ".base", "headerDiv", !0, "ui-jqgrid-hdiv"), h = $(a).jqGrid("getStyleUI", a.p.styleUI + ".common", "hover", !0), i = "border-box" === $("#gbox_" + $.jgrid.jqID(a.p.id)).css("box-sizing"), j = i ? 1 : 0; if (!0 !== a.p.subGrid && !0 !== a.p.treeGrid && !0 !== a.p.cellEdit && !a.p.sortable && !a.p.scroll && !0 !== a.p.grouping) {
                        for (; c < d && !0 === b[c].frozen;) f = !0, e = c, c++; if (e >= 0 && f) {
                            ...
                            n = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0); if (a.p.groupHeader) {
                                $("tr.jqg-first-row-header, tr.jqg-third-row-header", n).each(function () { $("th:gt(" + e + ")", this).remove() }); var
                                o, p, q = -1, r = -1; $("tr.jqg-second-row-header th", n).each(function () { if (o = parseInt($(this).attr("colspan"), 10), p = parseInt($(this).attr("rowspan"), 10), p && (q++, r++), o && (q += o, r++), q === e) return r = e, !1 }), q !== e && (r = e), $("tr.jqg-second-row-header", n).each(function () { $("th:gt(" + r + ")", this).remove() })
                            } else {
                                var
                                s = []; $(".ui-jqgrid-htable tr", "#gview_" + $.jgrid.jqID(a.p.id)).each(function (a, b) { s.push(parseInt($(this).height(), 10)) }), $("tr", n).each(function () { $("th:gt(" + e + ")", this).remove() }), $("tr", n).each(function (a) { $(this).height(s[a]) })
                            } if ($(n).width(1), $.jgrid.msie() || $(n).css("height", "100%"), $(a.grid.fhDiv).append(n).mousemove(function (b) { if (a.grid.resizing) return a.grid.dragMove(b), !1 }), a.p.footerrow) {
                                var
                                ...
                                u = $(".ui-jqgrid-ftable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0); $("tr", u).each(function () { $("td:gt(" + e + ")", this).remove() }), $(u).width(1), $(a.grid.fsDiv).append(u)
                                ...
                                $("#" + $.jgrid.jqID(a.p.id) + "_frozen").remove(), $(a.grid.fbDiv).height($(a.grid.bDiv).height() - 17); var
            ...
            return this.each(function () {
                if (this.grid && !0 === this.p.frozenColumns) {
                    var
                    a = this, b = $(a).jqGrid("getStyleUI", a.p.styleUI + ".common", "hover", !0); if ($(a.grid.fhDiv).remove(), $(a.grid.fbDiv).remove(), a.grid.fhDiv = null, a.grid.fbDiv = null, a.p.footerrow && ($(a.grid.fsDiv).remove(), a.grid.fsDiv = null), $(this).off(".setFrozenColumns"), !0 === a.p.hoverrows) {
                        var
        ...
        NumberFormat: function (b, c) {
            if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
                ...
                d, e = b < 0, f = String(b), g = c.decimalSeparator || "."; if (a.fmatter.isNumber(c.decimalPlaces)) {
                    var
                    h = c.decimalPlaces, i = Math.pow(10, h); if (f = String(Math.round(b * i) / i), d = f.lastIndexOf("."), h > 0) for (d < 0 ? (f += g, d = f.length - 1) : "." !== g && (f = f.replace(".", g)) ; f.length - 1 - d < h;) f += "0"
                } if (c.thousandsSeparator) {
                    var
                    j = c.thousandsSeparator; d = f.lastIndexOf(g), d = d > -1 ? d : f.length; var
                    k, l = f.substring(d), m = -1; for (k = d; k > 0; k--) m++, m % 3 == 0 && k !== d && (!e || k > 1) && (l = j + l), l = f.charAt(k - 1) + l; f = l
    ...
    "use strict"; a.extend(a.jgrid, {
        showModal: function (a) { a.w.show() }, closeModal: function (a) { a.w.hide().attr("aria-hidden", "true"), a.o && a.o.remove() }, hideModal: function (b, c) {
            ...
            } if (a.fn.jqm && !0 === c.jqm) a(b).attr("aria-hidden", "true").jqmHide(); else { if ("" !== c.gb) try { a(".jqgrid-overlay:first", c.gb).hide() } catch (a) { } a(b).hide().attr("aria-hidden", "true") } c.removemodal && a(b).remove()
        }, findPos: function (b) {
            var
            ...
            c.focusField || c.focusField ? c.focusField = 0 : c.focusField = !1, a.fn.jqm && !0 === c.jqm) c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else
                if ("" !== c.gbox && (a(".jqgrid-overlay:first", c.gbox).show(), a(b).data("gbox", c.gbox)), a(b).show().attr("aria-hidden", "false"), c.focusField >= 0) try { a(":input:visible", b)[c.focusField].focus() } catch (a) { }
...
g(b, c, d) {
            ...
            h = "", i = this; switch (b) {
                case "textarea": h = document.createElement("textarea"), e ? c.cols || a(h).css({ width: "98%" }) : c.cols || (c.cols = 20), c.rows || (c.rows = 2), ("&nbsp;" === d || "&#160;" === d || 1 === d.length && 160 === d.charCodeAt(0)) && (d = ""), h.value = d, g(h, c), a(h).attr({ role: "textbox", multiline: "true" }); break; case "checkbox": if (h = document.createElement("input"), h.type = "checkbox", c.value) {
                    var
                ...
                } g(h, c, ["value"]), a(h).attr("role", "checkbox"); break; case "select": h = document.createElement("select"), h.setAttribute("role", "select"); var
                l, m = []; if (!0 === c.multiple ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                                ...
                                0 === h.size && (h.size = j ? 3 : 1), j ? (d = f.split(","), d = a.map(d, function (b) { return a.trim(b) })) : d[0] = a.trim(f), a("option", e).each(function (b) { c = a(this).text(), f = a(this).val(), k && (l += (0 !== b ? ";" : "") + f + ":" + c), 0 === b && e.multiple && (this.selected = !1), a(this).attr("role", "option"), (a.inArray(a.trim(c), d) > -1 || a.inArray(a.trim(f), d) > -1) && (this.selected = "selected") }), k) if ("edit" === h.oper) a(i).jqGrid("setColProp", h.name, { editoptions: { buildSelect: null, dataUrl: null, value: l } }); else
                                    if ("search" === h.oper) a(i).jqGrid("setColProp", h.name, { searchoptions: { dataUrl: null, value: l } }); else
                                        if ("filter" === h.oper && a("#fbox_" + i.p.id)[0].p) {
                                            var
                                            n, p = a("#fbox_" + i.p.id)[0].p.columns; a.each(p, function (a) { if (n = this.index || this.name, h.name === n) return this.searchoptions.dataUrl = null, this.searchoptions.value = l, !1 })
                    ...
                    } break; case "image": case "file": h = document.createElement("input"), h.type = b, g(h, c); break; case "custom": h = document.createElement("span"); try {
                    ...
                    B; B = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, g(h, c), "button" !== b && (e ? c.size || a(h).css({ width: "96%" }) : c.size || (c.size = 20)), a(h).attr("role", B)
            } return h
                ...
                0 === e ? "_" : e; if (f) {
                    ...
                    p; if (!0 === f.email && !(!1 === o && a.jgrid.isEmpty(b) || (p = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, p.test(b)))) return [!1, h + ": " + n.email, ""]; if (!0 === f.integer && (!1 !== o || !a.jgrid.isEmpty(b))) { if (isNaN(b)) return [!1, h + ": " + n.integer, ""]; if (b % 1 != 0 || -1 !== b.indexOf(".")) return [!1, h + ": " + n.integer, ""] } if (!0 === f.date && !(!1 === o && a.jgrid.isEmpty(b) || (m[c].formatoptions && m[c].formatoptions.newformat ? (i = m[c].formatoptions.newformat, (k = a.jgrid.getRegional(l, "formatter.date.masks")) && k.hasOwnProperty(i) && (i = k[i])) : i = m[c].datefmt || "Y-m-d", a.jgrid.checkDate(i, b)))) return [!1, h + ": " + n.date + " - " + i, ""]; if (!0 === f.time && !(!1 === o && a.jgrid.isEmpty(b) || a.jgrid.checkTime(b))) return [!1, h + ": " + n.date + " - hh:mm (am/pm)", ""]; if (!0 === f.url && !(!1 === o && a.jgrid.isEmpty(b) || (p = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, p.test(b)))) return [!1, h + ": " + n.url, ""]; if (!0 === f.custom && (!1 !== o || !a.jgrid.isEmpty(b))) {
                        if (a.isFunction(f.custom_func)) {
                            var
                            q = f.custom_func.call(l, b, h, c); return a.isArray(q) ? q : [!1, n.customarray, ""]
                    ...
                    c, d = {}; a(A).find(".FormElement").each(function () {
                        ...
                        c = a(".customelement", this); if (c.length) {
                            ...
                            switch (a(this).get(0).type) {
                                ...
                                } break; case "select-one": u[this.name] = a(this).val(); break; case "select-multiple": u[this.name] = a(this).val(), u[this.name] = u[this.name] ? u[this.name].join(",") : ""; break; case "password": case "text": case "textarea": case "button": u[this.name] = a(this).val(); break; case "radio": if (d.hasOwnProperty(this.name)) return !0; d[this.name] = void
                        ...
                        if ("cb" !== (f = m[h].name) && "subgrid" !== f && "rn" !== f && !0 === m[h].editable) {
                            if (f === d.p.ExpandColumn && !0 === d.p.treeGrid) g = a(this).text(); else
                                try { g = a.unformat.call(d, a(this), { rowId: c, colModel: m[h] }, h) } catch (b) { g = "textarea" === m[h].edittype ? a(this).text() : a(this).html() } switch (s.p.autoencode && (g = a.jgrid.htmlDecode(g)), (!0 === b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (s.p.savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                    case "password": case "text": case "button": case "image": case "textarea": ("&nbsp;" === g || "&#160;" === g || 1 === g.length && 160 === g.charCodeAt(0)) && (g = ""), a("#" + f, e).val(g); break; case "select": var
...
r() {
                ...
                s = this; if (s.grid && c) {
                    ...
                    0 === C && (C = !0), C && a.isFunction(b[s.p.id].beforeInitData) && (C = b[s.p.id].beforeInitData.call(s, L, w)), !1 !== C) {
                        n(), f(c, s, I, D); var
                        M = "rtl" === s.p.direction, N = M ? "nData" : "pData", O = M ? "pData" : "nData", P = "<a id='" + N + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_prev + "'></span></a>", Q = "<a id='" + O + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_next + "'></span></a>", R = "<a id='sData' class='fm-button " + h.button + "'>" + d.bSubmit + "</a>", S = "<a id='cData' class='fm-button " + h.button + "'>" + d.bCancel + "</a>", T = "<table style='height:auto' class='EditTable ui-common-table' id='" + z + "_2'><tbody><tr><td colspan='2'><hr class='" + h.content + "' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (M ? Q + P : P + Q) + "</td><td class='EditButton'>" + R + S + "</td></tr>"; if (T += "</tbody></table>", E > 0) {
                            var
                            U = []; a.each(a(I)[0].rows, function (a, b) { U[a] = b }), U.sort(function (a, b) { return a.rp > b.rp ? 1 : a.rp < b.rp ? -1 : 0 }), a.each(U, function (b, c) { a("tbody", I).append(c) })
            ...
            e = a.jgrid.getRegional(this[0], "del"), f = this[0].p.styleUI, g = a.jgrid.styleUI[f].formedit, h = a.jgrid.styleUI[f].common; return d = a.extend(!0, { top: 0, left: 0, width: 240, height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: "", mtype: "POST", reloadAfterSubmit: !0, beforeShowForm: null, beforeInitData: null, afterShowForm: null, beforeSubmit: null, onclickSubmit: null, afterSubmit: null, jqModal: !0, closeOnEscape: !1, delData: {}, delicon: [], cancelicon: [], onClose: null, ajaxDelOptions: {}, processing: !1, serializeDelData: null, useDataProxy: !1 }, e, d || {}), b[a(this)[0].p.id] = d, this.each(function () {
                ...
                e = this; if (e.grid && c) {
                    ...
                    0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                        ...
                        }), a("#eData", "#" + o + "_2").click(function () { return a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), { gb: "#gbox_" + a.jgrid.jqID(l), jqm: b[e.p.id].jqModal, onClose: b[e.p.id].onClose }), !1 }), n = a(e).triggerHandler("jqGridDelRowBeforeInitData", [a("#" + o)]), void
            ...
            i = a.jgrid.getRegional(this[0], "nav"), j = this[0].p.styleUI, k = a.jgrid.styleUI[j].navigator, l = a.jgrid.styleUI[j].common; return c = a.extend({ edit: !0, editicon: k.icon_edit_nav, add: !0, addicon: k.icon_add_nav, del: !0, delicon: k.icon_del_nav, search: !0, searchicon: k.icon_search_nav, refresh: !0, refreshicon: k.icon_refresh_nav, refreshstate: "firstpage", view: !1, viewicon: k.icon_view_nav, position: "left", closeOnEscape: !0, beforeRefresh: null, afterRefresh: null, cloneToTop: !1, alertwidth: 200, alertheight: "auto", alerttop: null, alertleft: null, alertzIndex: null, dropmenu: !1, navButtonText: "" }, i, c || {}), this.each(function () {
                if (!this.p.navGrid) {
                    ...
                    b) {
                        ...
                        q, r = 1, s = function () { a(this).hasClass(l.disabled) || a(this).addClass(l.hover) }, t = function () { a(this).removeClass(l.hover) }; for (n.cloneToTop && p.p.toppager && (r = 2), q = 0; q < r; q++) {
                            var
                            u, v, w, x = a("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"), y = "<td class='ui-pg-button " + l.disabled + "' style='width:4px;'><span class='ui-separator'></span></td>"; 0 === q ? (v = b, w = p.p.id, v === p.p.toppager && (w += "_top", r = 1)) : (v = p.p.toppager, w = p.p.id + "_top"), "rtl" === p.p.direction && a(x).attr("dir", "rtl").css("float", "right"), e = e || {}, n.add && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.addicon + "'></span>" + n.addtext + "</div>"), a("tr", x).append(u), a(u, x).attr({ title: n.addtitle || "", id: e.id || "add_" + w }).click(function () { return a(this).hasClass(l.disabled) || (a.isFunction(n.addfunc) ? n.addfunc.call(p) : a(p).jqGrid("editGridRow", "new", e)), !1 }).hover(s, t), u = null), d = d || {}, n.edit && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.editicon + "'></span>" + n.edittext + "</div>"), a("tr", x).append(u), a(u, x).attr({ title: n.edittitle || "", id: d.id || "edit_" + w }).click(function () {
                                if (!a(this).hasClass(l.disabled)) {
                                    var
                                    b = p.p.selrow; b ? a.isFunction(n.editfunc) ? n.editfunc.call(p, b) : a(p).jqGrid("editGridRow", b, d) : (a.jgrid.viewModal("#" + o.themodal, { gbox: "#gbox_" + a.jgrid.jqID(p.p.id), jqm: !0 }), a("#jqg_alrt").focus())
                                } return !1
                                ...
                                if (!a(this).hasClass(l.disabled)) {
                                    var
                                    b = p.p.selrow; b ? a.isFunction(n.viewfunc) ? n.viewfunc.call(p, b) : a(p).jqGrid("viewGridRow", b, h) : (a.jgrid.viewModal("#" + o.themodal, { gbox: "#gbox_" + a.jgrid.jqID(p.p.id), jqm: !0 }), a("#jqg_alrt").focus())
                                } return !1
                                ...
                                if (!a(this).hasClass(l.disabled)) {
                                    var
                                    b; p.p.multiselect ? (b = p.p.selarrrow, 0 === b.length && (b = null)) : b = p.p.selrow, b ? a.isFunction(n.delfunc) ? n.delfunc.call(p, b) : a(p).jqGrid("delGridRow", b, f) : (a.jgrid.viewModal("#" + o.themodal, { gbox: "#gbox_" + a.jgrid.jqID(p.p.id), jqm: !0 }), a("#jqg_alrt").focus())
                                } return !1
                            }).hover(s, t), u = null), (n.add || n.edit || n.del || n.view) && a("tr", x).append(y), g = g || {}, n.search && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.searchicon + "'></span>" + n.searchtext + "</div>"), a("tr", x).append(u), a(u, x).attr({ title: n.searchtitle || "", id: g.id || "search_" + w }).click(function () { return a(this).hasClass(l.disabled) || (a.isFunction(n.searchfunc) ? n.searchfunc.call(p, g) : a(p).jqGrid("searchGrid", g)), !1 }).hover(s, t), g.showOnLoad && !0 === g.showOnLoad && a(u, x).click(), u = null), n.refresh && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.refreshicon + "'></span>" + n.refreshtext + "</div>"), a("tr", x).append(u), a(u, x).attr({ title: n.refreshtitle || "", id: "refresh_" + w }).click(function () {
                                if (!a(this).hasClass(l.disabled)) {
                                    ...
                                    } catch (a) { } switch (n.refreshstate) { case "firstpage": a(p).trigger("reloadGrid", [{ page: 1 }]); break; case "current": case "currentfilter": a(p).trigger("reloadGrid", [{ current: !0 }]) } a.isFunction(n.afterRefresh) && n.afterRefresh.call(p)
                                } return !1
            ...
            if (!this.filter) {
                ...
                b, c, d = this.p.columns.length, f = /msie/i.test(navigator.userAgent) && !window.opera; if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    k = function (b, c) {
                        ...
                        s, t = a("<select class='" + i.srSelect + "'></select>"), u = []; r.append(t), t.on("change", function () {
                        ...
                        A = a("<select class='selectopts " + i.srSelect + "'></select>"); for (y.append(A), A.on("change", function () {
        ...
        filterToolbar: function (b) {
            ...
            c = a.jgrid.getRegional(this[0], "search"); return b = a.extend({ autosearch: !0, autosearchDelay: 500, searchOnEnter: !0, beforeSearch: null, afterSearch: null, beforeClear: null, afterClear: null, onClearSearchValue: null, url: "", stringResult: !1, groupOp: "AND", defaultSearch: "bw", searchOperators: !1, resetIcon: "x", splitSelect: ",", groupOpSelect: "OR", operands: { eq: "==", ne: "!", lt: "<", le: "<=", gt: ">", ge: ">=", bw: "^", bn: "!^", in: "=", ni: "!=", ew: "|", en: "!@", cn: "~", nc: "!~", nu: "#", nn: "!#", bt: "..." } }, c, b || {}), this.each(function () {
                ...
                d = this; if (!d.p.filterToolbar) {
                    a(d).data("filterToolbar") || a(d).data("filterToolbar", b), d.p.force_regional && (b = a.extend(b, c)); var
                    e, f, g, h = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter, i = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = function () {
                        var
                        c, e, f, g, h = {}, i = 0, j = {}, k = !1, l = [], m = !1; a.each(d.p.colModel, function () {
                            var
                        ...
                        n = i > 0; if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
                            var
                            ...
                            0 === q.groups && (q.groups = []), w = { groupOp: "AND", groups: [], rules: [] }, q.groups.push(w), a.each(v, function (a) {
                                var
                                b = 0 === a ? "ge" : "le"; (t = v[a]) && w.rules.push({ data: v[a], op: b, field: u.field })
                            }), r.splice(s, 1), s--)); (m || k) && (o = JSON.stringify(q)), a.extend(d.p.postData, { filters: o }), a.each(["searchField", "searchString", "searchOper"], function (a, b) {
                            ...
                            y = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch"); !y && a.isFunction(b.beforeSearch) && (y = b.beforeSearch.call(d)), y || a(d).jqGrid("setGridParam", { search: n }).trigger("reloadGrid", [{ page: 1 }]), x && a(d).jqGrid("setGridParam", { url: x }), a(d).triggerHandler("jqGridToolbarAfterSearch"), a.isFunction(b.afterSearch) && b.afterSearch.call(d)
                    }, l = function (c) {
                        var
                        ...
                        s = d.p.colModel[p], t = a.extend({}, s.searchoptions); for (t.sopt || (t.sopt = [], t.sopt[0] = "select" === s.stype ? "eq" : b.defaultSearch), a.each(b.odata, function () { o.push(this.oper) }), p = 0; p < t.sopt.length; p++) -1 !== (j = a.inArray(t.sopt[p], o)) && (g = n === b.odata[j].oper ? i.highlight : "", m += '<li class="ui-menu-item ' + g + '" role="presentation"><a class="' + i.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[j].oper + '" oper="' + b.operands[b.odata[j].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + b.operands[b.odata[j].oper] + "</td><td>" + b.odata[j].text + "</td></tr></table></a></li>"); m += "</ul>", a("body").append(m), a("#sopt_menu").addClass("ui-menu " + h.menu_widget), a("#sopt_menu > li > a").hover(function () { a(this).addClass(i.hover) }, function () { a(this).removeClass(i.hover) }).click(function () {
                            ...
                            e = a(this).attr("value"), f = a(this).attr("oper"); if (a(d).triggerHandler("jqGridToolbarSelectOper", [e, f, c]), a("#sopt_menu").hide(), a(c).text(f).attr("soper", e), !0 === b.autosearch) {
                                var
                                g = a(c).parent().next().children()[0]; (a(g).val() || "nu" === e || "nn" === e) && k()
                            }
                        })
                    }, o = a("<tr class='ui-search-toolbar' role='row'></tr>"); b.restoreFromFilters && (g = d.p.postData.filters) && ("string" == typeof
                    g && (g = a.jgrid.parse(g)), f = !!g.rules.length && g.rules), a.each(d.p.colModel, function (c) {
                        ...
                        0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), g = a.extend({}, this.searchoptions, { name: s.index || s.name, id: "gs_" + d.p.idPrefix + s.name, oper: "search" }), this.search) {
                            ...
                            0 === g.clearSearch && (g.clearSearch = !0), g.clearSearch ? (n = b.resetTitle || "Clear Search Value", a("td:eq(2)", x).append("<a title='" + n + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + b.resetIcon + "</a>")) : a("td:eq(2)", x).hide(), this.surl && (g.dataUrl = this.surl), p = "", g.defaultValue && (p = a.isFunction(g.defaultValue) ? g.defaultValue.call(d) : g.defaultValue), b.restoreFromFilters && r && (p = r.data), q = a.jgrid.createEl.call(d, this.stype, g, p, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), a(q).addClass(h.srInput), a("td:eq(1)", x).append(q), a(w).append(x), null == g.dataEvents && (g.dataEvents = []), this.stype) {
                                case "select": !0 === b.autosearch && g.dataEvents.push({ type: "change", fn: function () { return k(), !1 } }); break; case "text": !0 === b.autosearch && (b.searchOnEnter ? g.dataEvents.push({ type: "keypress", fn: function (a) { return 13 === (a.charCode || a.keyCode || 0) ? (k(), !1) : this } }) : g.dataEvents.push({
                                    type: "keydown", fn: function (a) {
                                        switch (a.which) {
                                            ...
                                            39: case
                                            40: case
                                            27: break; default: e && clearTimeout(e), e = setTimeout(function () { k() }, b.autosearchDelay)
                                        }
                                    }
                                }))
...
c(f) {
                    if (f && f.rules) {
                        for (g = f.rules, l = g.length, d = 0; d < l; d++) h = g[d], -1 !== (i = a.inArray(h.field, m)) && (e = a("#gs_" + j.p.idPrefix + a.jgrid.jqID(k[i].name)), e.length > 0 && ("select" === k[i].stype ? e.find("option[value='" + a.jgrid.jqID(h.data) + "']").prop("selected", !0) : "text" === k[i].stype && e.val(h.data), a.isFunction(b.onSetVal) && b.onSetVal.call(j, e, k[i].name))); if (f.groups) for (var
                        n = 0; n < f.groups.length; n++) c(f.groups[n])
                    }
                } var
                d, e, f, g, h, i, j = this, k = j.p.colModel, l = j.p.colModel.length, m = []; if (j.p.filterToolbar) {
                    for (d = 0; d < l; d++) { switch (m.push(k[d].name), e = a("#gs_" + j.p.idPrefix + a.jgrid.jqID(k[d].name)), k[d].stype) { case "select": case "text": e.val("") } a.isFunction(b.onClearVal) && b.onClearVal.call(j, e, k[d].name) } "string" == typeof
            ...
            c = a.jgrid.getRegional(this[0], "search"); return b = a.extend(!0, {
                ...
                0, onClose: null, onSearch: null, onReset: null, toTop: !0, overlay: 30, columns: [], tmplNames: null, tmplFilters: null, tmplLabel: " Template: ", showOnLoad: !1, layer: null, splitSelect: ",", groupOpSelect: "OR", operands: { eq: "=", ne: "<>", lt: "<", le: "<=", gt: ">", ge: ">=", bw: "LIKE", bn: "NOT LIKE", in: "IN", ni: "NOT IN", ew: "LIKE", en: "NOT LIKE", cn: "LIKE", nc: "NOT LIKE", nu: "IS NULL", nn: "ISNOT NULL" }
...
c(c) {
                ...
                d = this; if (d.grid) {
                    ...
                    0 !== a("#" + a.jgrid.jqID(i.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(d.p.id))); else {
                        ...
                        p, q, r = a.extend([], d.p.colModel), s = "<a id='" + f + "_search' class='fm-button " + l.button + " fm-button-icon-right ui-search'><span class='" + l.icon_base + " " + k.icon_search + "'></span>" + b.Find + "</a>", t = "<a id='" + f + "_reset' class='fm-button " + l.button + " fm-button-icon-left ui-reset'><span class='" + l.icon_base + " " + k.icon_reset + "'></span>" + b.Reset + "</a>", u = "", v = "", w = !1, x = -1, y = !1, z = []; if (b.showQuery && (u = "<a id='" + f + "_query' class='fm-button " + l.button + " fm-button-icon-left'><span class='" + l.icon_base + " " + k.icon_query + "'></span>Query</a>"), b.columns.length ? (r = b.columns, x = 0, p = r[0].index || r[0].name) : a.each(r, function (a, b) {
                        ...
                        0 === b.search || b.search, e = !0 === b.hidden; (b.searchoptions && !0 === b.searchoptions.searchhidden && c || c && !e) && (w = !0, p = b.index || b.name, x = a)
                            ...
                            var
                            A = "eq"; x >= 0 && r[x].searchoptions && r[x].searchoptions.sopt ? A = r[x].searchoptions.sopt[0] : b.sopt && b.sopt.length && (A = b.sopt[0]), j = { groupOp: "AND", rules: [{ field: p, op: A, data: "" }] }
        ...
        editRow: function (b, c, d, e, f, g, h, i, j) {
            ...
            0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, { keys: !1, keyevent: "keydown", oneditfunc: null, successfunc: null, url: null, extraparam: {}, aftersavefunc: null, errorfunc: null, afterrestorefunc: null, restoreAfterError: !0, mtype: "POST", focusField: !0, saveui: "enable", savetext: a.jgrid.getRegional(m, "defaults.savetext") }, a.jgrid.inlineEdit, k), this.each(function () {
                ...
                if (m.grid && !1 !== (f = a(m).jqGrid("getInd", b, !0))) {
                    ...
                    }, 0)), !0 === k.keys && a(f).on(k.keyevent, function (c) { if (27 === c.keyCode) { if (a(m).jqGrid("restoreRow", b, k), m.p.inlineNav) try { a(m).jqGrid("showAddEditButtons") } catch (a) { } return !1 } if (13 === c.keyCode) { if ("TEXTAREA" === c.target.tagName) return !0; if (a(m).jqGrid("saveRow", b, k) && m.p.inlineNav) try { a(m).jqGrid("showAddEditButtons") } catch (a) { } return !1 } }), a(m).triggerHandler("jqGridInlineEditRow", [b, k]), a.isFunction(k.oneditfunc) && k.oneditfunc.call(m, b)))
                }
            })
            ...
            d = this[0], e = a.jgrid.getRegional(d, "nav"), f = a.jgrid.styleUI[d.p.styleUI].inlinedit; return c = a.extend(!0, { edit: !0, editicon: f.icon_edit_nav, add: !0, addicon: f.icon_add_nav, save: !0, saveicon: f.icon_save_nav, cancel: !0, cancelicon: f.icon_cancel_nav, addParams: { addRowParams: { extraparam: {} } }, editParams: {}, restoreAfterSelect: !0, saveAfterSelect: !1 }, e, c || {}), this.each(function () {
                if (this.grid && !this.p.inlineNav) {
                    ...
                    }), a("#" + f + "_ilcancel").addClass(g)), !0 !== c.restoreAfterSelect && !0 !== c.saveAfterSelect || a(d).on("jqGridBeforeSelectRow.inlineNav", function (b, e) { d.p.savedRow.length > 0 && !0 === d.p.inlineNav && e !== d.p.selrow && null !== d.p.selrow && (d.p.selrow === c.addParams.rowID ? a(d).jqGrid("delRowData", d.p.selrow) : !0 === c.restoreAfterSelect ? a(d).jqGrid("restoreRow", d.p.selrow, c.editParams) : a(d).jqGrid("saveRow", d.p.selrow, c.editParams), a(d).jqGrid("showAddEditButtons")) })
                }
            })
    ...
    "use strict"; a.jgrid.extend({
        editCell: function (b, c, d) {
            return this.each(function () {
                var
                e, f, g, h, i = this, j = a(this).jqGrid("getStyleUI", i.p.styleUI + ".common", "highlight", !0), k = a(this).jqGrid("getStyleUI", i.p.styleUI + ".common", "hover", !0), l = a(this).jqGrid("getStyleUI", i.p.styleUI + ".celledit", "inputClass", !0); if (i.grid && !0 === i.p.cellEdit) {
                    if (c = parseInt(c, 10), i.p.selrow = i.rows[b].id, i.p.knv || a(i).jqGrid("GridNav"), i.p.savedRow.length > 0) { if (!0 === d && b == i.p.iRow && c == i.p.iCol) return; a(i).jqGrid("saveCell", i.p.savedRow[0].id, i.p.savedRow[0].ic) } else
                        window.setTimeout(function () { a("#" + a.jgrid.jqID(i.p.knv)).attr("tabindex", "-1").focus() }, 1); if (h = i.p.colModel[c], "subgrid" !== (e = h.name) && "cb" !== e && "rn" !== e) {
                            try { g = a(i.rows[b].cells[c]) } catch (d) { g = a("td:eq(" + c + ")", i.rows[b]) } if (!0 !== h.editable || !0 !== d || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c)) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j), g.addClass("edit-cell " + j), a(i.rows[b]).addClass("selected-row " + k), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c); else {
                                parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j), g.addClass("edit-cell " + j), a(i.rows[b]).addClass("selected-row " + k); try { f = a.unformat.call(i, g, { rowId: i.rows[b].id, colModel: h }, c) } catch (a) { f = h.edittype && "textarea" === h.edittype ? g.text() : g.html() } if (i.p.autoencode && (f = a.jgrid.htmlDecode(f)), h.edittype || (h.edittype = "text"), i.p.savedRow.push({ id: b, ic: c, name: e, v: f }), ("&nbsp;" === f || "&#160;" === f || 1 === f.length && 160 === f.charCodeAt(0)) && (f = ""), a.isFunction(i.p.formatCell)) {
                                    var
                                    m = i.p.formatCell.call(i, i.rows[b].id, e, f, b, c); void
                                    0 !== m && (f = m)
                                } a(i).triggerHandler("jqGridBeforeEditCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.beforeEditCell) && i.p.beforeEditCell.call(i, i.rows[b].id, e, f, b, c); var
            ...
            return this.each(function () {
                var
                d, e = this, f = a.jgrid.getRegional(this, "errors"), g = a.jgrid.getRegional(this, "edit"); if (e.grid && !0 === e.p.cellEdit) {
                    if (null !== (d = e.p.savedRow.length >= 1 ? 0 : null)) {
                        var
                        h, i, j = a("td:eq(" + c + ")", e.rows[b]), k = e.p.colModel[c], l = k.name, m = a.jgrid.jqID(l), n = a(j).offset(); switch (k.edittype) {
                            case "select": if (k.editoptions.multiple) {
                                var
                                o = a("#" + b + "_" + m, e.rows[b]), p = []; h = a(o).val(), h ? h.join(",") : h = "", a("option:selected", o).each(function (b, c) { p[b] = a(c).text() }), i = p.join(",")
                            } else
                                h = a("#" + b + "_" + m + " option:selected", e.rows[b]).val(), i = a("#" + b + "_" + m + " option:selected", e.rows[b]).text(); k.formatter && (i = h); break; case "checkbox": var
                                q = ["Yes", "No"]; k.editoptions && k.editoptions.value && (q = k.editoptions.value.split(":")), h = a("#" + b + "_" + m, e.rows[b]).is(":checked") ? q[0] : q[1], i = h; break; case "password": case "text": case "textarea": case "button": h = a("#" + b + "_" + m, e.rows[b]).val(), i = h; break; case "custom": try {
                                    if (!k.editoptions || !a.isFunction(k.editoptions.custom_value)) throw "e1"; if (void
                                    0 === (h = k.editoptions.custom_value.call(e, a(".customelement", j), "get"))) throw "e2"; i = h
                                } catch (b) { "e1" === b ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.nodefined, g.bClose, { styleUI: e.p.styleUI }) : "e2" === b ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.novalue, g.bClose, { styleUI: e.p.styleUI }) : a.jgrid.info_dialog(f.errcap, b.message, g.bClose, { styleUI: e.p.styleUI }) }
                        } if (i !== e.p.savedRow[d].v) {
                            var
                            r = a(e).triggerHandler("jqGridBeforeSaveCell", [e.rows[b].id, l, h, b, c]); if (r && (h = r, i = r), a.isFunction(e.p.beforeSaveCell)) {
                                var
                                s = e.p.beforeSaveCell.call(e, e.rows[b].id, l, h, b, c); s && (h = s, i = s)
                            } var
                            t = a.jgrid.checkValues.call(e, h, c), u = !1; if (!0 === t[0]) {
                                var
                                ...
                                0 === (w = e.p.onSubmitCell(e.rows[b].id, l, h, b, c)) && (w = !0), !1 === w) return; if (a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit) if (e.p.cellurl) {
                                    var
                                    x = {}; e.p.autoencode && (h = a.jgrid.htmlEncode(h)), k.editoptions && k.editoptions.NullIfEmpty && "" === h && (h = "null", u = !0), x[l] = h; var
                                    y, z, A; A = e.p.prmNames, y = A.id, z = A.oper, x[y] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id), x[z] = A.editoper, x = a.extend(v, x), a(e).jqGrid("progressBar", { method: "show", loadtype: e.p.loadui, htmlcontent: a.jgrid.getRegional(e, "defaults.savetext") }), e.grid.hDiv.loading = !0, a.ajax(a.extend({
                                        url: e.p.cellurl, data: a.isFunction(e.p.serializeCellData) ? e.p.serializeCellData.call(e, x, l) : x, type: "POST", complete: function (d, k) {
            ...
            return this.each(function () {
                var
                d, e = this; if (e.grid && !0 === e.p.cellEdit) {
                    if (null !== (d = e.p.savedRow.length >= 1 ? 0 : null)) {
                        var
            ...
            return this.each(function () {
                var
                d, e = this, f = !1; if (e.grid && !0 === e.p.cellEdit) { for (d = c + 1; d < e.p.colModel.length; d++) if (!0 === e.p.colModel[d].editable && (!a.isFunction(e.p.isCellEditable) || e.p.isCellEditable.call(e, e.p.colModel[d].name, b, d))) { f = d; break } !1 !== f ? a(e).jqGrid("editCell", b, f, !0) : e.p.savedRow.length > 0 && a(e).jqGrid("saveCell", b, c) }
            })
        }, prevCell: function (b, c) {
            return this.each(function () {
                var
                d, e = this, f = !1; if (e.grid && !0 === e.p.cellEdit) { for (d = c - 1; d >= 0; d--) if (!0 === e.p.colModel[d].editable && (!a.isFunction(e.p.isCellEditable) || e.p.isCellEditable.call(e, e.p.colModel[d].name, b, d))) { f = d; break } !1 !== f ? a(e).jqGrid("editCell", b, f, !0) : e.p.savedRow.length > 0 && a(e).jqGrid("saveCell", b, c) }
            })
        }, GridNav: function () {
            return this.each(function () {
                function 
                ...
                d = this; if (d.grid && !0 === d.p.cellEdit) {
                    ...
                    e, f, g = a("<div style='position:fixed;top:0px;width:1px;height:1px;' tabindex='0'><div tabindex='-1' style='width:1px;height:1px;' id='" + d.p.knv + "'></div></div>"); a(g).insertBefore(d.grid.cDiv), a("#" + d.p.knv).focus().keydown(function (g) {
                        switch (f = g.keyCode, "rtl" === d.p.direction && (37 === f ? f = 39 : 39 === f && (f = 37)), f) {
                            ...
                            13: parseInt(d.p.iCol, 10) >= 0 && parseInt(d.p.iRow, 10) >= 0 && a(d).jqGrid("editCell", d.p.iRow, d.p.iCol, !0); break; default: return !0
                        } return !1
                    })
                }
            })
        ...
        setSubGrid: function () {
            ...
            return this.each(function () {
                ...
                d = this; if (d.grid) {
                    ...
                    e, f, g, h, i, j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, l = function (b, c, e) {
                        ...
                        e, f, g, h = a("<table class='" + j.rowTable + " ui-common-table'><tbody></tbody></table>"), i = a("<tr></tr>"); for (f = 0; f < d.p.subGridModel[0].name.length; f++) e = a("<th class='" + j.headerBox + " ui-th-subgrid ui-th-column ui-th-" + d.p.direction + "'></th>"), a(e).html(d.p.subGridModel[0].name[f]), a(e).width(d.p.subGridModel[0].width[f]), a(i).append(e); a(h).append(i), b && (g = d.p.xmlReader.subgrid, a(g.root + " " + g.row, b).each(function () {
                            if (i = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === g.repeatitems) a(g.cell, this).each(function (b) { l(i, a(this).text() || "&#160;", b) }); else {
                                var
                                b = d.p.subGridModel[0].mapping || d.p.subGridModel[0].name; if (b) for (f = 0; f < b.length; f++) l(i, a(b[f], this).text() || "&#160;", f)
                            } a(h).append(i)
                        })); var
                        ...
                        0 !== (f = a.jgrid.getAccessor(b, i.root)))) for (g = 0; g < f.length; g++) {
                            if (h = f[g], o = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === i.repeatitems) for (i.cell && (h = h[i.cell]), m = 0; m < h.length; m++) l(o, h[m] || "&#160;", m); else {
                                var
                                p = d.p.subGridModel[0].mapping || d.p.subGridModel[0].name; if (p.length) for (m = 0; m < p.length; m++) l(o, h[p[m]] || "&#160;", m)
                            } a(n).append(o)
                        } var
                    ...
                    })), s++; !0 === d.p.subGridOptions.expandOnLoad && a(d.rows).filter(".jqgrow").each(function (b, c) { a(c.cells[0]).click() }), d.subGridXml = function (a, b) { m(a, b) }, d.subGridJson = function (a, b) { n(a, b) }
                }
            })
        ...
        groupingSetup: function () {
            ...
            return this.each(function () {
                ...
                g, h, i = e.join("_"), j = d.minusicon, k = d.plusicon, l = a("#" + a.jgrid.jqID(b)), m = l.length ? l[0].nextSibling : null, n = a("#" + a.jgrid.jqID(b) + " span.tree-wrap-" + c.p.direction), o = function (b) {
                    ...
                    0
                }, p = !1, q = !1, r = !!c.p.frozenColumns && c.p.id + "_frozen", s = !!r && a("#" + a.jgrid.jqID(b), "#" + a.jgrid.jqID(r)), t = s && s.length ? s[0].nextSibling : null; if (n.hasClass(j)) {
                    if (m) for (; m && !(void
                    0 !== (g = o(m.className)) && g <= f) ;) a(m).hide(), m = m.nextSibling, r && (a(t).hide(), t = t.nextSibling); n.removeClass(j).addClass(k), p = !0
                } else {
                    if (m) for (h = void
                    0; m;) {
                        ...
                        0 !== g) { if (g <= f) break; g === f + 1 && (q || (a(m).show().find(">td>span.tree-wrap-" + c.p.direction).removeClass(j).addClass(k), r && a(t).show().find(">td>span.tree-wrap-" + c.p.direction).removeClass(j).addClass(k))) } else
                            h && (q || (a(m).show(), r && a(t).show())); m = m.nextSibling, r && (t = t.nextSibling)
...
g(b, d, e, g) {
                    var
                    h, i, j = f(b, d, e), l = k.p.colModel, m = j.cnt, n = ""; for (i = g; i < c; i++) {
                        var
                        o = "<td " + k.formatCol(i, 1, "") + ">&#160;</td>", p = "{0}"; a.each(j.summary, function () {
                            if (this.nm === l[i].name) {
                                l[i].summaryTpl && (p = l[i].summaryTpl), "string" == typeof
                                this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && m > 0 && (this.v = this.v / m)); try { this.groupCount = j.cnt, this.groupIndex = j.dataIndex, this.groupValue = j.value, h = k.formatter("", this.v, i, this) } catch (a) { h = this.v } return o = "<td " + k.formatCol(i, 1, "") + ">" + a.jgrid.template(p, h, j.cnt) + "</td>", !1
                            }
                        }), n += o
                    } return n
                } var
                    ...
                    w && (w = j), "header" === l.groupSummaryPos[v.idx] ? (m += '<tr id="' + h + '"' + (l.groupCollapse && v.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "' + r.content + " jqgroup ui-row-" + k.p.direction + " " + i + '"><td style="padding-left:' + 12 * v.idx + 'px;"' + s + ">" + n + w + "</td>", m += g(f, 0, l.groups, !1 === l.groupColumnShow[v.idx] ? "" === s ? 2 : 3 : "" === s ? 1 : 2), m += "</tr>") : m += '<tr id="' + h + '"' + (l.groupCollapse && v.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "' + r.content + " jqgroup ui-row-" + k.p.direction + " " + i + '"><td style="padding-left:' + 12 * v.idx + 'px;" colspan="' + (!1 === l.groupColumnShow[v.idx] ? c - 1 : c) + '">' + n + w + "</td></tr>", q - 1 === v.idx) {
                        ...
                        0 !== z ? z.startRow : l.groups[f].startRow + l.groups[f].cnt; for (l._locgr && (A = (d - 1) * e) > v.startRow && (B = A), x = B; x < C && b[x - A]; x++) m += b[x - A].join(""); if ("header" !== l.groupSummaryPos[v.idx]) {
                            ...
                            0 !== z) { for (D = 0; D < l.groupField.length && z.dataIndex !== l.groupField[D]; D++); t = l.groupField.length - D } for (y = 0; y < t; y++) if (u[y]) {
                                var
                                E = ""; l.groupCollapse && !l.showSummaryOnHide && (E = ' style="display:none;"'), m += "<tr" + E + ' jqfootlevel="' + (v.idx - y) + '" role="row" class="' + r.content + " jqfoot ui-row-" + k.p.direction + '">', m += g(f, y, l.groups, 0), m += "</tr>"
                            } t = D
                        }
                    }
    ...
    "use strict"; a.jgrid.extend({
        setTreeNode: function (b, c) {
            ...
            this.each(function () {
                ...
                c = this; if (c.grid && c.p.treeGrid) {
                    ...
                    0 === g && (g = !0), g && a.isFunction(c.p.beforeExpandTreeGridRow) && (g = c.p.beforeExpandTreeGridRow.call(c, f, b, d)), !1 !== g && (a(d).each(function () {
                        var
                        b = c.p.idPrefix + a.jgrid.getAccessor(this, c.p.localReader.id); a(a(c).jqGrid("getGridRowById", b)).css("display", ""), this[e] && a(c).jqGrid("expandRow", this)
            ...
            c = []; return this.each(function () {
                ...
                b && (b = !1), f = b ? a(g).jqGrid("getRowData", null, !0) : g.p.data, g.p.treeGridModel) { case "nested": d = g.p.treeReader.level_field, a(f).each(function () { parseInt(this[d], 10) === parseInt(g.p.tree_root_level, 10) && (b ? c.push(g.p.data[g.p._index[this[g.p.keyName]]]) : c.push(this)) }); break; case "adjacency": e = g.p.treeReader.parent_id_field, a(f).each(function () { null !== this[e] && "null" !== String(this[e]).toLowerCase() || (b ? c.push(g.p.data[g.p._index[this[g.p.keyName]]]) : c.push(this)) }) }
            }), c
            ...
            d = []; return this.each(function () {
                var
                e = this; if (e.grid && e.p.treeGrid) {
                    var
                    f, g, h = c ? this.rows.length : this.p.data.length; switch (e.p.treeGridModel) {
                        case "nested": var
                        ...
                        o = e.p.treeReader.parent_id_field, p = e.p.localReader.id; for (f = 0; f < h; f++) (g = c ? e.p.data[e.p._index[this.rows[f].id]] : e.p.data[f]) && String(g[o]) === String(a.jgrid.stripPref(e.p.idPrefix, b[p])) && d.push(g)
                    }
                }
            }), d
            ...
            return this.each(function () {
                ...
                c, d, e, f, g, h = this, i = h.p.localReader.id, j = h.p.treeReader.left_field, k = h.p.treeReader.right_field; if (h.grid && h.p.treeGrid) {
                    ...
                    0 !== l) {
                        ...
                        m = a(h).jqGrid("getFullTreeNode", h.p.data[l]); if (m.length > 0) for (c = 0; c < m.length; c++) a(h).jqGrid("delRowData", m[c][i]); if ("nested" === h.p.treeGridModel) {
            ...
            return this.each(function () {
                ...
                c, d, e, f, g = this, h = g.p.localReader.id, i = g.p.treeReader.left_field, j = g.p.treeReader.right_field; if (g.grid && g.p.treeGrid) {
                    ...
                    0 !== k) {
                        ...
                        m = 0; m < l.length; m++) l[m][h] !== b && a(g).jqGrid("delRowData", l[m][h]); if ("nested" === g.p.treeGridModel) {
            ...
            f = this[0]; if (d) {
                ...
                0 === c || null === c || "" === c) c = null, w = null, g = "last", j = f.p.tree_root_level, k = f.p.data.length + 1; else {
                    g = "after", h = f.p._index[c], i = f.p.data[h], c = i[f.p.localReader.id], j = parseInt(i[q], 10) + 1; var
                ...
                0 === d[p] && (d[p] = !0), "adjacency" === f.p.treeGridModel && (d[r] = c), "nested" === f.p.treeGridModel) {
                    ...
                    z, A, B; if (null !== c) {
                        ...
                        in
                        A) A.hasOwnProperty(B) && (A[B][s] = A[B][s] > n ? parseInt(A[B][s], 10) + 2 : A[B][s], A[B][t] = A[B][t] >= n ? parseInt(A[B][t], 10) + 2 : A[B][t]); d[s] = n, d[t] = n + 1
                    } else {
                        ...
                        in
                        A) A.hasOwnProperty(B) && (A[B][t] = parseInt(A[B][t], 10) + 2); d[s] = n + 1, d[t] = n + 2
                    }
...
p(a) {
            ...
            return this.each(function () {
                function 
f(b) {
                    if (!a.isArray(b)) throw "data provides is not an array"; var
                    e, f, h, i, j = jQuery(g).jqGrid("pivotSetup", b, c), k = a.assocArraySize(j.summary) > 0, l = a.jgrid.from.call(g, j.rows); for (c.ignoreCase && (l = l.ignoreCase()), e = 0; e < j.groupOptions.groupingView.groupField.length; e++) f = c.xDimension[e].sortorder ? c.xDimension[e].sortorder : "asc", h = c.xDimension[e].sorttype ? c.xDimension[e].sorttype : "text", l.orderBy(j.groupOptions.groupingView.groupField[e], f, h, "", h); if (i = c.xDimension.length, d.sortname) { for (f = d.sortorder ? d.sortorder : "asc", h = "text", e = 0; e < i; e++) if (c.xDimension[e].dataName === d.sortname) { h = c.xDimension[e].sorttype ? c.xDimension[e].sorttype : "text"; break } l.orderBy(d.sortname, f, h, "", h) } else
                        ...
                        m = j.groupHeaders; if (m.length) for (e = 0; e < m.length; e++) m[e] && m[e].groupHeaders.length && jQuery(g).jqGrid("setGroupHeaders", m[e]); c.frozenStaticCols && jQuery(g).jqGrid("setFrozenColumns")
                } var
    ...
    "use strict"; a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        saveState: function (b, c) {
            if (c = a.extend({ useStorage: !0, storageType: "localStorage", beforeSetItem: null, compression: !1, compressionModule: "LZString", compressionMethod: "compressToUTF16", debug: !1, saveData: !0 }, c || {}), b) {
                ...
                d, e, f = "", g = "", h = a("#" + b)[0]; if (h.grid) {
                    if (e = a(h).data("inlineNav"), e && h.p.inlineNav && a(h).jqGrid("setGridParam", { _iN: e }), e = a(h).data("filterToolbar"), e && h.p.filterToolbar && a(h).jqGrid("setGridParam", { _fT: e }), f = a(h).jqGrid("jqGridExport", { exptype: "jsonstring", ident: "", root: "" }), g = "", c.saveData) {
                ...
                e, f, g, h, i, j = a("#" + b)[0]; if (d.useStorage) try { c = window[d.storageType].getItem("jqGrid" + j.id), g = window[d.storageType].getItem("jqGrid" + j.id + "_data") } catch (a) { } if (c) {
                    if (d.decompression && d.decompressionModule) try { e = window[d.decompressionModule][d.decompressionMethod](c), null != e && (c = e, g = window[d.decompressionModule][d.decompressionMethod](g)) } catch (a) { } if ((e = a.jgrid.parseFunc(c)) && "object" === a.type(e)) {
                        ...
                        e.navButtons[n][1] ? m.jqGrid("navSeparatorAdd", e.navButtons[n][0], e.navButtons[n][1]) : m.jqGrid("navButtonAdd", e.navButtons[n][0], e.navButtons[n][1]); if (m[0].refreshIndex(), e.subGrid) {
                            var
                            o = 1 === e.multiselect ? 1 : 0, p = !0 === e.rownumbers ? 1 : 0; m.jqGrid("addSubGrid", o + p)
        ...
        jqGridExport: function (b) {
            b = a.extend({ exptype: "xmlstring", root: "grid", ident: "\t", addOptions: {} }, b || {}); var
            c = null; return this.each(function () {
                if (this.grid) {
                    var
                    d = a.extend(!0, {}, a(this).jqGrid("getGridParam"), b.addOptions); switch (d.rownumbers && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.multiselect && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.subGrid && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.knv = null, b.exptype) { case "xmlstring": c = "<" + b.root + ">" + a.jgrid.jsonToXML(d, { xmlDecl: "" }) + "</" + b.root + ">"; break; case "jsonstring": c = a.jgrid.stringify(d), b.root && (c = "{" + b.root + ":" + c + "}") }
                }
            }), c
    ...
    "use strict"; a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        formatCell: function (b, c, d, e, f) {
            ...
            0 !== e.formatter) {
                var
                h = { rowId: "", colModel: e, gid: f.p.id, pos: c, styleUI: "" }; g = a.isFunction(e.formatter) ? e.formatter.call(f, b, h, d) : a.fmatter ? a.fn.fmatter.call(f, e.formatter, b, h, d) : b
            } else
                g = b; return g
            ...
            var
            e = b.createElement(c); return d && (d.attr && a(e).attr(d.attr), d.children && a.each(d.children, function (a, b) { e.appendChild(b) }), d.text && e.appendChild(b.createTextNode(d.text))), e
...
e(b, e, f, g) {
            ...
            Array(c.collen), p = 0; for (i = g; i < l; i++) if (!k[i].hidden) {
            var
            q = "{0}"; a.each(m.summary, function () {
            if (this.nm === k[i].name) {
            k[i].summaryTpl && (q = k[i].summaryTpl), "string" == typeof
            this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && n > 0 && (this.v = this.v / n)); try { this.groupCount = m.cnt, this.groupIndex = m.dataIndex, this.groupValue = m.value, h = j.formatter("", this.v, i, this) } catch (a) { h = this.v } return o[p] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(a.jgrid.template(q, h)), c), !1
            }
            }), p++
            } return o
            } var
            f = "", g = j.p.groupingView, h = [], i = g.groupField.length, k = j.p.colModel, l = k.length, m = 0; a.each(k, function (a, b) {
            var
            c; for (c = 0; c < i; c++) if (g.groupField[c] === b.name) { h[c] = a; break }
            }); var
            n, o, p = a.makeArray(g.groupSummary); return p.reverse(), a.each(g.groups, function (d, l) {
            m++; try { n = a.isArray(g.formatDisplayField) && a.isFunction(g.formatDisplayField[l.idx]) ? g.formatDisplayField[l.idx].call(j, l.displayValue, l.value, j.p.colModel[h[l.idx]], l.idx, g) : j.formatter("", l.displayValue, h[l.idx], l.value) } catch (a) { n = l.displayValue } var
            ...
            0 !== v ? v.startRow : g.groups[d].startRow + g.groups[d].cnt; for (s = x; s < y && b[s - w]; s++) { for (u = b[s - w], o = 0, t = 0; t < k.length; t++) k[t].hidden || (r[o] = a.jgrid.formatCellCsv(a.jgrid.formatCell(u[k[t].name], t, u, k[t], j), c), o++); f += r.join(c.separator) + c.newLine } if ("header" !== g.groupSummaryPos[l.idx]) {
            var
            z; if (void
            0 !== v) { for (z = 0; z < g.groupField.length && v.dataIndex !== g.groupField[z]; z++); m = g.groupField.length - z } for (t = 0; t < m; t++) p[t] && (r = e(d, t, g.groups, 0), f += r.join(c.separator) + c.newLine); m = z
            }
            }
            }), f
            } b._regexsep = new
            ...
            e, f, g, h, i, j = this, k = this.addLocalData(!0), l = k.length, m = j.p.colModel, n = m.length, o = j.p.colNames, p = 0, q = "", r = "", s = "", t = "", u = "", v = [], w = [], x = [], y = []; if (a.each(m, function (c, d) {
            void
            ...
            Array(b.collen), b.includeCaption && j.p.caption) { for (p = b.collen; --p;) g[p] = ""; g[0] = a.jgrid.formatCellCsv(j.p.caption, b), r += g.join(b.separator) + b.newLine } if (b.includeGroupHeader && j.p.groupHeader && j.p.groupHeader.length) {
            var
            z = j.p.groupHeader; for (e = 0; e < z.length; e++) {
            var
            A = z[e].groupHeaders; for (p = 0, g = [], i = 0; i < x.length; i++) { for (g[p] = "", h = 0; h < A.length; h++) A[h].startColumnName === x[i] && (g[p] = a.jgrid.formatCellCsv(A[h].titleText, b)); p++ } s += g.join(b.separator) + b.newLine
            }
            } if (b.includeFooter && j.p.footerrow) {
            var
            B = a(".ui-jqgrid-ftable", this.sDiv); if (B.length) {
            var
            C = B[0].rows[0]; for (e = 0, p = 0, g = []; e < C.cells.length;) {
            var
            D = C.cells[e], E = a(D).attr("aria-describedby").slice(-3); D.hidden || "_cb" === E || "_rn" === E || (g[p] = a.jgrid.formatCellCsv(a(D).text(), b), p++), e++
            } t += g.join(b.separator) + b.newLine
            }
            } for (c = r + s + u + q + t, e = 0; e < w.length; e++) m[w[e]].hidden = !1; for (e = 0; e < y.length; e++) m[y[e]].hidden = !1
            }), b.returnAsString) return c; a.jgrid.saveAs(c, b.fileName, { type: b.mimetype })
        }, exportToExcel: function (b) {
            b = a.extend(!0, { includeLabels: !0, includeGroupHeader: !0, includeFooter: !0, fileName: "jqGridExport.xlsx", mimetype: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", maxlength: 40, onBeforeExport: null, replaceStr: null }, b || {}), this.each(function () {
                function 
...
d(b, d, f, h) {
                        var
                        i, k, l = c(b, d, f), n = l.cnt, p = e(o.header); for (k = h; k < j; k++) if (!m[k].hidden && !m[k].exportcol) {
                            var
                            q = "{0}"; a.each(l.summary, function () {
                                if (this.nm === m[k].name) {
                                    m[k].summaryTpl && (q = m[k].summaryTpl), "string" == typeof
                                    this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && n > 0 && (this.v = this.v / n)); try { this.groupCount = l.cnt, this.groupIndex = l.dataIndex, this.groupValue = l.value, i = g.formatter("", this.v, k, this) } catch (a) { i = this.v } return p[this.nm] = a.jgrid.stripHtml(a.jgrid.template(q, i)), !1
                                }
                            })
                        } return p
                    } function 
e(a) {
                    ...
                    f = g.p.groupingView, h = [], i = f.groupField.length, j = m.length, k = 0; a.each(m, function (a, b) {
                        var
                        c; for (c = 0; c < i; c++) if (f.groupField[c] === b.name) { h[c] = a; break }
                    }); var
                    l, n = a.makeArray(f.groupSummary); n.reverse(), a.each(f.groups, function (c, j) {
                        k++; try { l = a.isArray(f.formatDisplayField) && a.isFunction(f.formatDisplayField[j.idx]) ? f.formatDisplayField[j.idx].call(g, j.displayValue, j.value, g.p.colModel[h[j.idx]], j.idx, f) : g.formatter("", j.displayValue, h[j.idx], j.value) } catch (a) { l = j.displayValue } var
                        ...
                        Array(5 * j.idx).join(" ") + m), s(p, !0), i - 1 === j.idx) {
                            ...
                            0 !== t ? t.startRow : f.groups[c].startRow + f.groups[c].cnt; for (q = v; q < w && b[q - u]; q++) {
                                var
                                x = b[q - u]; s(x, !1)
                            } if ("header" !== f.groupSummaryPos[j.idx]) {
                                var
                                y; if (void
                                0 !== t) { for (y = 0; y < f.groupField.length && t.dataIndex !== f.groupField[y]; y++); k = f.groupField.length - y } for (r = 0; r < k; r++) n[r] && (p = d(c, r, f.groups, 0), s(p, !0)); k = y
                            }
                        }
                    })
                } var
                ...
                p, q, r = a.isFunction(b.replaceStr) ? b.replaceStr : c, s = function (c, d) {
                    p = i + 1, q = a.jgrid.makeNode(j, "row", { attr: { r: p } }); for (var
                    e = 0; e < o.header.length; e++) {
                        ...
                        l || l.match && a.trim(l).match(/^-?\d+(\.\d+)?$/) && !a.trim(l).match(/^0\d+/)) f = a.jgrid.makeNode(j, "c", { attr: { t: "n", r: h }, children: [a.jgrid.makeNode(j, "v", { text: l })] }); else {
                            var
                            n = l.replace ? r(l) : l; f = a.jgrid.makeNode(j, "c", { attr: { t: "inlineStr", r: h }, children: { row: a.jgrid.makeNode(j, "is", { children: { row: a.jgrid.makeNode(j, "t", { text: n }) } }) } })
                        } q.appendChild(f)
                    } k.appendChild(q), i++
                }; if (a("sheets sheet", l.xl["workbook.xml"]).attr("name", b.sheetName), b.includeGroupHeader && g.p.groupHeader && g.p.groupHeader.length) {
                    var
                    t, u, v = g.p.groupHeader, w = [], x = 0; for (u = 0; u < v.length; u++) {
                        var
                        y = v[u].groupHeaders, z = {}; for (x++, e = 0, e = 0; e < o.header.length; e++) {
                            t = o.header[e], z[t] = ""; for (var
                            A = 0; A < y.length; A++) if (y[A].startColumnName === t) {
                                z[t] = y[A].titleText; var
                                B = a.jgrid.excelCellPos(e) + x, C = a.jgrid.excelCellPos(e + y[A].numberOfColumns - 1) + x; w.push({ ref: B + ":" + C })
                            }
                        } s(z, !0)
                    } a("row c", j).attr("s", "2"); var
                    D = a.jgrid.makeNode(j, "mergeCells", { attr: { count: w.length } }); for (a("worksheet", j).append(D), n = 0; n < w.length; n++) D.appendChild(a.jgrid.makeNode(j, "mergeCell", { attr: w[n] }))
                    ...
                    E = 0, F = o.body.length; E < F; E++) s(o.body[E], !1); if (b.includeFooter || g.p.footerrow) {
                        o.footer = a(g).jqGrid("footerData", "get"); for (n
                        in
                        o.footer) o.footer.hasOwnProperty(n) && (o.footer[n] = a.jgrid.stripHtml(o.footer[n])); s(o.footer, !0), a("row:last c", j).attr("s", "2")
                    } var
                    G = a.jgrid.makeNode(j, "cols"); for (a("worksheet", j).prepend(G), n = 0, f = o.width.length; n < f; n++) G.appendChild(a.jgrid.makeNode(j, "col", { attr: { min: n + 1, max: n + 1, width: o.width[n], customWidth: 1 } })); a.isFunction(b.onBeforeExport) && b.onBeforeExport(l), o = null; try {
                        var
                        H = new
                        JSZip, I = { type: "blob", mimeType: b.mimetype }; a.jgrid.xmlToZip(H, l), H.generateAsync ? H.generateAsync(I).then(function (c) { a.jgrid.saveAs(c, b.fileName, { type: b.mimetype }) }) : a.jgrid.saveAs(H.generate(I), b.fileName, { type: b.mimetype })
                    } catch (a) { throw a }
            })
        }, exportToPdf: function (b) {
            return b = a.extend(!0, { title: null, orientation: "portrait", pageSize: "A4", description: null, onBeforeExport: null, download: "download", includeLabels: !0, includeGroupHeader: !0, includeFooter: !0, fileName: "jqGridExport.pdf", mimetype: "application/pdf" }, b || {}), this.each(function () {
                function 
c(b) {
                    function 
c(b, c) {
                        for (var
                        d = 0, e = [], f = 0; f < m.length; f++) k = { text: null == b[m[f]] ? "" : c ? a.jgrid.formatCell(b[m[f]] + "", o[d], l[n], q[o[d]], h) : b[m[f]], alignment: r[f], style: "tableBody" }, e.push(k), d++; return e
                    } function 
d(a, b, c) {
                        var
                        d, e = !1; if (0 === b) e = c[a]; else {
...
e(b, c, e, g) {
                        var
                        i, j, k = d(b, c, e), l = k.cnt, n = f(m); for (j = g; j < s; j++) if (!q[j].hidden && q[j].exportcol) {
                            var
                            o = "{0}"; a.each(k.summary, function () {
                                if (this.nm === q[j].name) {
                                    q[j].summaryTpl && (o = q[j].summaryTpl), "string" == typeof
                                    this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && l > 0 && (this.v = this.v / l)); try { this.groupCount = k.cnt, this.groupIndex = k.dataIndex, this.groupValue = k.value, i = h.formatter("", this.v, j, this) } catch (a) { i = this.v } return n[this.nm] = a.jgrid.stripHtml(a.jgrid.template(o, i)), !1
                                }
                            })
                        } return n
                    } function 
f(a) {
                    ...
                    g = h.p.groupingView, j = [], p = g.groupField.length, q = h.p.colModel, s = q.length, t = 0; a.each(q, function (a, b) {
                        var
                        c; for (c = 0; c < p; c++) if (g.groupField[c] === b.name) { j[c] = a; break }
                    }); var
                    u, v = a.makeArray(g.groupSummary); v.reverse(), a.each(g.groups, function (d, k) {
                        t++; try { u = a.isArray(g.formatDisplayField) && a.isFunction(g.formatDisplayField[k.idx]) ? g.formatDisplayField[k.idx].call(h, k.displayValue, k.value, h.p.colModel[j[k.idx]], k.idx, g) : h.formatter("", k.displayValue, j[k.idx], k.value) } catch (a) { u = k.displayValue } var
                        ...
                        Array(5 * k.idx).join(" ") + l), i.push(c(n, !1)), p - 1 === k.idx) {
                            ...
                            0 !== r ? r.startRow : g.groups[d].startRow + g.groups[d].cnt; for (o = w; o < x && b[o - s]; o++) {
                                var
                                y = b[o - s]; i.push(c(y, !0))
                            } if ("header" !== g.groupSummaryPos[k.idx]) {
                                var
                                z; if (void
                                0 !== r) { for (z = 0; z < g.groupField.length && r.dataIndex !== g.groupField[z]; z++); t = g.groupField.length - z } for (q = 0; q < t; q++) v[q] && (n = e(d, q, g.groups, 0), i.push(c(n, !1))); t = z
                            }
                        }
                    })
                } var
                ...
                s; if (b.includeGroupHeader && h.p.groupHeader && h.p.groupHeader.length) for (s = h.p.groupHeader, n = 0; n < s.length; n++) {
                    var
                    t = [], u = s[n].groupHeaders; for (f = 0; f < m.length; f++) { for (k = { text: "", style: "tableHeader" }, g = 0; g < u.length; g++) u[g].startColumnName === m[f] && (k = { text: u[g].titleText, colSpan: u[g].numberOfColumns, style: "tableHeader" }); t.push(k), d++ } i.push(t)
                } if (b.includeLabels && i.push(p), h.p.grouping) c(l); else {
                    var
                    v; for (n = 0, e = l.length; n < e; n++) { for (g = 0, p = [], v = l[n], f = 0; f < m.length; f++) k = { text: null == v[m[f]] ? "" : a.jgrid.formatCell(v[m[f]] + "", o[g], l[n], j[o[g]], h), alignment: r[m[f]], style: "tableBody" }, p.push(k), g++; i.push(p) }
                } if (b.includeFooter && h.p.footerrow) {
                    var
                    w = a(h).jqGrid("footerData", "get"); for (p = [], f = 0; f < m.length; f++) k = { text: a.jgrid.stripHtml(w[m[f]]), style: "tableFooter", alignment: r[m[f]] }, p.push(k); i.push(p)
                } var
                x = { pageSize: b.pageSize, pageOrientation: b.orientation, content: [{ style: "tableExample", widths: q, table: { headerRows: null != s ? 0 : 1, body: i } }], styles: { tableHeader: { bold: !0, fontSize: 11, color: "#2e6e9e", fillColor: "#dfeffc", alignment: "center" }, tableBody: { fontSize: 10 }, tableFooter: { bold: !0, fontSize: 11, color: "#2e6e9e", fillColor: "#dfeffc" }, title: { alignment: "center", fontSize: 15 }, description: {} }, defaultStyle: { fontSize: 10 } }; b.description && x.content.unshift({ text: b.description, style: "description", margin: [0, 0, 0, 12] }), b.title && x.content.unshift({ text: b.title, style: "title", margin: [0, 0, 0, 12] }), a.isFunction(b.onBeforeExport) && b.onBeforeExport.call(h, x); try {
                    var
                    y = pdfMake.createPdf(x); "open" === b.download ? y.open() : y.getBuffer(function (c) { a.jgrid.saveAs(c, b.fileName, { type: b.mimetype }) })
                } catch (a) { throw a }
            })
        }
    })
        ...
        stringify: function (a) {
            ...
            return JSON.parse(str, function (key, value) {
                ...
                value && -1 !== value.indexOf("function")) {
                    var
                    sv = value.split(" "); return "function" === sv[0].trim() && "}" === value.trim().slice(-1) ? eval("(" + value + ")") : value
                } return value
            })
...
c() { setTimeout(function () { d.p.disableClick = !1 }, 50) } var
                d = this, e = $.jgrid.jqID(d.p.id), f = {
                    ...
                    var
                    g = f.start; f.start = function (a, c) { b(), g.call(this, a, c) }
                } else
                    f.start = b; if (f.stop) {
                        var
                        h = f.stop; f.stop = function (a, b) { c(), h.call(this, a, b) }
                    } else
                        f.stop = c; d.p.sortable.exclude && (f.items += ":not(" + d.p.sortable.exclude + ")"); var
                        i = a.sortable(f), j = i.data("sortable") || i.data("uiSortable"); null != j && (j.data("sortable").floating = !0)
            })
...
b() {
                ...
                c, d, e = this; if (e.grid && !e.p.treeGrid && $.fn.draggable && $.fn.droppable) {
                    ...
                    return $.extend({
                        accept: function (a) {
                    if (!$(a).hasClass("jqgrow")) return a; if (f = $(a).closest("table.ui-jqgrid-btable"), f.length > 0 && void
                    0 !== $.data(f[0], "dnd")) {
                    var
                    b = $.data(f[0], "dnd").connectWith; return -1 !== $.inArray("#" + $.jgrid.jqID(this.id), b)
                    } return !1
                    }, drop: function (b, c) {
                    if ($(c.draggable).hasClass("jqgrow")) {
                    var
                    d = $(c.draggable).attr("id"), e = c.draggable.parent().parent().jqGrid("getRowData", d); if (!a.dropbyname) {
                    var
                    g, h, i = 0, j = {}, k = $("#" + $.jgrid.jqID(this.id)).jqGrid("getGridParam", "colModel"); try {
                    for (h
                    in
                    e) e.hasOwnProperty(h) && (g = k[i].name, "cb" !== g && "rn" !== g && "subgrid" !== g && e.hasOwnProperty(h) && k[i] && (j[g] = e[h]), i++); e = j
                    } catch (a) { }
                    ...
                    var
                    m; a.autoid && ($.isFunction(a.autoid) ? m = a.autoid.call(this, e) : (m = Math.ceil(1e3 * Math.random()), m = a.autoidprefix + m)), $("#" + $.jgrid.jqID(this.id)).jqGrid("addRowData", m, e, a.droppos)
