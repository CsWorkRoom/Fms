...
namespace Easyman.EntityFramework
{
    public abstract class EasymanDbContext : AbpZeroDbContext<Tenant, Role, User>
    {
         ...
         *   Notice that, actually you will not directly create an instance of EasymanDbContext since ABP automatically handles it.
         */
        public EasymanDbContext(string nameOrConnectionString)
        ...
        public EasymanDbContext(DbConnection connection)
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            ////关闭启动校验
            //Database.SetInitializer<EasymanDbContext>(null);
