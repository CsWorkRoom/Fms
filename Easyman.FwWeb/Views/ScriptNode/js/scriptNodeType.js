...
function InitPage() {
    table = $('#dataTableDiv').ztable({
        action: "../api/services/api/ScriptNodeType/GetScriptNodeTypeSearch",
        pageSize: 10,
        fields: {
            Id: {
                title: "标识",
...
function ondelete(id) {
    abp.message.confirm(
        ...
        function (isConfirmed) {
            if (isConfirmed) {
                App.post("../api/services/api/ScriptNodeType/DeleteScriptNodeType", JSON.stringify({ id: id }), function (result) {
